...
 ',
    ...
    'cc_only' => 'بطاقة ائتمان فقط',
    'e_invoice_forward_email' => 'خدمة إعادة توجيه البريد الإلكتروني من بيبول',
    'e_invoice_forward_email_help' => 'إعادة توجيه الفواتير الإلكترونية المرسلة/المستلمة إلى خدمة معالجة تابعة لجهة خارجية مثل Yuki أو WinAuditor',
