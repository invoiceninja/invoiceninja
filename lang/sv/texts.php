...
$lang = array(
    ...
    'no_passkeys_registered' => 'Inga lösennycklar är registrerade för det här kontot. Använd lösenordsinloggning eller registrera en lösennyckel först.',
...
Den här funktionen kräver att en produkt skapas och en betalningsgateway är konfigurerad.',
    ...
    'pro_upgrade_feature1' => 'DittVarumärke.fakturering.co',
...
<br />Aktivera detta om din webbläsare automatiskt laddar hem PDF:erna.',
    ...
    'applied' => 'Applicerad',
    'applied_date' => 'Tillämpat datum',
    'applied_amount' => 'Tillämpat belopp',
    'applied_refunded' => 'Tillämpad återbetalning',
    ...
    'invoice_not_related_to_payment' => 'Fakturanummer :invoice är inte relaterat till denna betalning',
    'credit_not_related_to_payment' => 'Kreditnummer :credit är inte relaterat till denna betalning',
    ...
    'notification_invoice_overdue_subject' => 'Fakturan :invoice är försenad för :client',
    'notification_invoice_overdue' => 'Följande faktura :invoice för klienten :client och :amount är nu förfallen.',
    ...
    'invoices_by_month' => 'Fakturor per månad',
    'payments_by_month' => 'Betalningar per månad',
    'monthly_breakdown_skipped' => 'Månadsuppdelning hoppades över: datumintervallet överstiger 24 månader',
    ...
    'mobile_payment' => 'Mobilbetalning',
    'awaiting_payment' => 'Väntar på betalning',
    'payment_confirmed' => 'Betalning bekräftad',
    'payment_expired' => 'Betalningen har upphört att gälla. Gå tillbaka och försök igen.',
    'payment_was_not_completed' => 'Betalningen slutfördes inte. Försök igen.',
    'no_compatible_app_installed' => 'Om ingenting händer kanske du inte har en kompatibel app installerad.',
    'payment_type_Mobile Payment' => 'Mobilbetalning',
    'gateway_temporarily_unavailable' => 'Denna betalningsmetod är tillfälligt otillgänglig. Försök igen senare eller välj en annan betalningsmetod.',
    'mybank' => 'MyBank',
    ...
    'show_pdfhtml_on_mobile' => 'Visa HTML-version vid visning på mobil',
    ...
    'use_unapplied_payments' => 'Använd oanvända betalningar',
    ...
    'end_all_sessions_help' => 'Loggar ut alla användare, kräver att användarna autentiserar sig på nytt.',
    ...
    'peppol_credits_info' => 'E-krediter krävs för att skicka och ta emot e-fakturor. Dessa debiteras per dokument. Om du redan har krediter klickar du på Fortsätt.',
    ...
    'of_budget' => 'av budgeten',
    'invoiced_hours' => 'Fakturerade timmar',
    'less' => 'Mindre',
    ...
    'einvoice_token_not_found' => 'E-faktureringstoken hittades inte. Gå till Inställningar &gt; E-faktura och generera token på nytt.',
    ...
    'preference_product_notes_for_html_view' => 'Använd objektanteckningar för HTML-vy',
    'preference_product_notes_for_html_view_help' => 'Föredra artikelbeskrivningen framför artikeltiteln om fakturan visas i HTML.',
    'project_report' => 'Projektrapport',
    'unlock_invoice_documents_after_payment' => 'Lås upp dokument efter betalning',
    'unlock_invoice_documents_after_payment_help' => 'Ger klienten åtkomst till fakturadokument när en faktura har betalats',
    'quickbooks' => 'QuickBooks',
    'disable_emails' => 'Inaktivera e-postmeddelanden',
    'disable_emails_error' => 'Du har inte behörighet att skicka e-postmeddelanden',
    'disable_emails_help' => 'Förhindrar att en användare skickar e-postmeddelanden från systemet',
    'add_location' => 'Lägg till plats',
    'updated_location' => 'Uppdaterad plats',
    'created_location' => 'Skapad plats',
    'sync_send_time' => 'Synkronisera sändningstid',
    'sync_send_time_help' => 'Uppdatera alla påminnelser/återkommande fakturor för att använda den nya sändningstiden',
    'edit_location' => 'Redigera plats',
    'downgrade' => 'Nedvärdera',
    'downgrade_to_free' => 'Nedgradera till gratisplanen',
    'downgrade_to_free_description' => 'Detta kommer att ta bort alla betalda funktioner från ditt konto.',
    'delete_location' => 'Ta bort plats',
    'delete_location_confirmation' => 'Detta kommer att ta bort platsen från klientens register.',
    'add_card_reminder' => 'Du kan lägga till ett kort igen när som helst.',
    'free_trial_then' => 'Gratis provperiod då',
    'days_left' => ':day s dagar kvar',
    'days_trial' => ':day s dagars provperiod',
    'pro_plan_label' => 'Ninja Pro',
    'enterprise_plan_label' => 'Företag',
    'premium_business_plus_label' => 'Premium Business+',
    'pro_plan_feature_1' => 'Obegränsat antal kunder och fakturor',
    'pro_plan_feature_2' => 'Ta bort &quot;Skapad av Fakturaninja&quot;',
    'pro_plan_feature_3' => 'E-postfakturor via Gmail och Microsoft',
    'pro_plan_feature_4' => 'Skicka fakturor via e-post via din anpassade SMTP',
    'pro_plan_feature_5' => 'Varumärkes-URL: &quot;Din webbplats&quot;.Fakturering.co',
    'pro_plan_feature_6' => '11 professionella fakturamallar',
    'pro_plan_feature_7' => 'Anpassa fakturadesigner',
    'pro_plan_feature_8' => 'API-integration med tredjepartsappar',
    'pro_plan_feature_9' => 'Lösenordsskyddad klientportal',
    'pro_plan_feature_10' => 'Konfigurera automatiska påminnelsemeddelanden',
    'pro_plan_feature_11' => 'Automatiskt bifogad faktura i PDF-format till e-postmeddelanden',
    'pro_plan_feature_12' => 'Visa kunders e-signatur på fakturor',
    'pro_plan_feature_13' => "Aktivera kryssrutan &quot;Godkänn villkor&quot;",
    'pro_plan_feature_14' => 'Rapporter: Fakturor, utgifter, resultaträkningar, mer',
    'pro_plan_feature_15' => 'Massfakturor, offerter och krediter via e-post',
    'pro_plan_feature_16' => 'Interlink 10 företag med 1 inloggning',
    'pro_plan_feature_17' => 'Skapa unika inställningar för &quot;klientgrupp&quot;',
    'pro_plan_feature_18' => 'Beräkning av bilförsäljningsskatt (amerikanska delstater)',
    'enterprise_plan_feature_1' => 'Ytterligare kontoanvändare och behörigheter',
    'enterprise_plan_feature_2' => 'Ladda upp och bifoga filer',
    'enterprise_plan_feature_3' => 'Anpassad portaldomän',
    'enterprise_plan_feature_4' => 'Bankkontosynkronisering',
    'premium_business_plus_feature_1' => 'Utvecklare Concierge',
    'premium_business_plus_feature_2' => 'Direkt prioriterat stöd',
    'premium_business_plus_feature_3' => 'Fakturadesigntjänst',
    'premium_business_plus_feature_4' => 'Prioritet för funktionsförfrågningar',
    'premium_business_plus_feature_5' => 'Hjälp med datamigrering',
    'premium_business_plus_feature_6' => 'Skapa anpassade rapporter',
    'upgrade_popup_headline' => 'Mer än fakturering',
    'upgrade_popup_description' => 'Enkel prissättning. Avancerade funktioner.',
    'upgrade_popup_pro_headline' => 'Betala året i 10 månader + 2 gratis!',
    'upgrade_popup_enterprise_headline' => 'Betala året i 10 månader + 2 gratis!',
    'upgrade_popup_premium_business_plus_headline' => 'Pro + Enterprise + Premium Business Concierge',
    'all_free_features_plus' => 'Alla gratisfunktioner +',
    'all_pro_features_plus' => 'Alla proffsfunktioner +',
    'all_features_plus' => 'Alla funktioner +',
    'upgrade_plan' => 'Uppgraderingsplan',
    'upgrade_popup_premium_business_plus_pricing' => 'Prissättning? Låt oss prata!',
    'plan_selected' => 'Plan vald',
    'invalid_date_create_syntax' => 'Ogiltig datumsyntax',
    'start_and_end_date_required' => 'Start- och slutdatum krävs',
    'project_value' => 'Projektvärde',
    'invalid_csv_data' => 'Ogiltig CSV-data, din import avbröts.',
    'selected_products' => 'Utvalda produkter',
    'create_company_error_unauthorized' => 'Du har inte behörighet att skapa ett företag. Endast kontoinnehavaren kan skapa ett företag.',
    'deleted_location' => 'Plats borttagen',
    'currency_caribbean_guilder' => 'Karibiska gulden',
    'is_shipping' => 'Är frakt',
    'added_location' => 'Platsen har lagts till',
    'send_emails' => 'Skicka e-postmeddelanden',
    'send_emails_permission' => 'Tillåt användaren att skicka e-postmeddelanden',
    'cancel_trial' => 'Avbryt provperioden',
    'cancel_trial_description' => 'Detta kommer att avbryta din provperiod och ta bort alla betalda funktioner från ditt konto.',
    'existing_gateway' => 'Gatewayen finns redan',
    'docuninja' => 'DocuNinja',
    'pro_rata' => 'Pro rata',
    'change_docuninja_plan' => 'Ändra DocuNinja-planen',
    'downgrade_end_of_cycle' => 'Ditt abonnemang nedgraderas automatiskt i slutet av den nuvarande faktureringsperioden.',
    'docuninja_change_users' => 'Ny användargräns för DocuNinja',
    'docuninja_disable_warning' => 'Detta kommer att ta bort all åtkomst till ditt DocuNinja-konto.',
    'docuninja_downgrade_info' => 'Din användargräns minskas automatiskt i slutet av den nuvarande faktureringsperioden.',
    'docuninja_grant_access_help' => 'Ge Invoice Ninja-användare åtkomst till DocuNinja',
    'recurring_invoice_item' => 'Återkommande fakturapost',
    'disable_recurring_payment_notification' => 'Inaktivera återkommande betalningsaviseringar',
    'disable_recurring_payment_notification_help' => 'Aviseringar om lyckade återkommande fakturabetalningar skickas inte.',
    'invoice_outstanding_tasks' => 'Fakturera utestående uppgifter',
    'payment_schedule' => 'Betalningsschema',
    'time_zone' => 'Tidszon',
    'tax_names' => 'Skattenamn',
    'auto_bill_help' => 'Om aktiverat, kommer automatisk fakturering att försökas för det schemalagda beloppet när schemat körs',
    'choose_schedule_type' => 'Välj schematyp',
    'split_payments' => 'Delade betalningar',
    'split_payments_help' => 'Delar upp fakturabeloppet i flera betalningar över en tidsperiod. dvs. 4 betalningar under 4 månader',
    'custom_schedule' => 'Skapa manuellt ett anpassat betalningsschema',
    'custom_schedule_help' => 'Skapa ett anpassat betalningsschema, gör det möjligt att skapa exakta datum och belopp för varje schema',
    'schedule_frequency_help' => 'Intervallet mellan varje betalning',
    'first_payment_date' => 'Första betalningsdatum',
    'first_payment_date_help' => 'Datumet för den första betalningen',
    'payment_schedule_interval' => 'Betalningsindex för :total för :amount',
    'payment_schedule_table' => 'Betalning: tryck på :date för :amount',
    'auto_send' => 'Automatisk sändning',
    'auto_send_help' => 'Skicka fakturan automatiskt till klienten via e-post',
    'include_project_tasks' => 'Inkludera projektuppgifter',
    'include_project_tasks_help' => 'Även faktureringsuppgifter som ingår i ett projekt',
    'tax_nexus' => 'Skattekoppling',
    'tax_period_report' => 'Rapport om skatteperiod',
    'creator' => 'Skapad av',
    'ses_topic_arn_help' => 'SES-ämnet (valfritt, endast för webhook-spårning)',
    'ses_region_help' => 'AWS-regionen, dvs. us-east-1',
    'ses_secret_key' => 'SES hemlig nyckel',
    'ses_access_key' => 'SES-åtkomstnyckel-ID',
    'lifecycle' => 'Livscykel',
    'order_columns' => 'Ordna kolumner',
    'topic_arn' => 'Ämne ARN',
    'lang_Catalan' => 'Katalanska',
    'lang_Afrikaans' => 'Afrikaans',
    'lang_Indonesian' => 'Indonesiska',
    'replaced' => 'Ersatt',
    'ses_from_address' => 'SES från adress',
    'ses_from_address_help' => 'Avsändar-e-postadressen måste verifieras i AWS',
    'unauthorized_action' => 'Du har inte behörighet att utföra den här åtgärden',
    'einvoice_received_subject' => 'E-faktura(or) mottagen',
    'einvoice_received_body' => 'Du har mottagit :count nya e-fakturor.<br><br> Logga in för att visa.',
    'download_files_too_large' => 'Vissa filer var för stora för att bifogas direkt till e-postmeddelandet. Använd länkarna nedan för att ladda ner dem separat.',
    'restore_disabled_verifactu' => 'Du kan inte återställa en faktura när den har raderats',
    'delete_disabled_verifactu' => 'Du kan inte radera en faktura när den har annullerats eller ändrats',
    'rectify' => 'Rätta till',
    'verifactu_invoice_send_success' => 'Fakturan :invoice för :client har skickats till AEAT.',
    'verifactu_invoice_sent_failure' => 'Fakturan :invoice för :client kunde inte skickas till AEAT :notes',
    'verifactu_cancellation_send_success' => 'Fakturamaullering för :invoice har skickats till AEAT',
    'verifactu_cancellation_send_failure' => 'Fakturamallering för :invoice misslyckades med att skicka till AEAT :notes',
    'verifactu' => 'Verifiering',
    'justify' => 'Rättfärdiga',
    'outdent' => 'Dra ut',
    'indent' => 'Indrag',
    'clear_filters' => 'Rensa filter',
    'feedback' => 'Feed-back',
    'feedback_modal_description' => 'Vi vill gärna höra din feedback!',
    'do_not_ask_again' => 'Fråga inte igen',
    'not_likely' => 'Inte troligt',
    'extremely_likely' => 'Extremt troligt',
    'feedback_slider_title' => 'Hur troligt är det att du skulle rekommendera Invoice Ninja till en vän eller kollega?',
    'actual_delivery_date' => 'Faktiskt leveransdatum',
    'actual_delivery_date_help' => 'Krävs ibland vid fakturering över gränser. Definierar EXAKT leveransdatum för varor.',
    'invoice_period' => 'Fakturaperiod',
    'invoice_period_help' => 'Definierar den tidsperiod under vilken tjänsterna tillhandahölls.',
    'paused_recurring_invoice_helper' => 'Varning! När du återupptar en återkommande faktura, se till att nästa sändningsdatum är i framtiden.',
    'thank_you_for_feedback' => 'Tack för din feedback!',
    'use_legacy_editor' => 'Använd den äldre Wysiwyg-redigeraren',
    'use_legacy_editor_help' => 'Använd TinyMCE-redigeraren.',
    'enable_e_invoice_received_notification' => 'Aktivera avisering om mottagen e-faktura',
    'enable_e_invoice_received_notification_help' => 'Få ett e-postmeddelande när en ny e-faktura tas emot.',
    'price_changes' => 'Planprisändringar från 1 januari 2026',
    'notification_quote_rejected_subject' => 'Citat :quote avvisades av :client',
    'notification_quote_rejected' => 'Följande klient :client avvisade offerten :quote för :amount :notes .',
    'activity_150' => 'Kontot raderades :notes',
    'activity_151' => 'Klienten :notes slogs samman med :client av :user',
    'activity_152' => 'Leverantören :notes slogs samman med :vendor av :user',
    'activity_153' => 'Klienten :notes rensades av :user',
    'activity_154' => 'E-faktura :invoice för :client har skickats till AEAT',
    'activity_155' => 'E-faktura :invoice för :client kunde inte skickas till AEAT :notes',
    'activity_156' => 'Fakturamaullering för :invoice har skickats till AEAT',
    'activity_157' => 'Fakturamallering för :invoice misslyckades med att skicka till AEAT :notes',
    'activity_158' => 'Citat :quote avvisades av :client :notes',
    'quotes_with_status_sent_can_be_rejected' => 'Endast offerter med statusen &quot;Skickad&quot; kan avvisas.',
    'reject' => 'Avvisa',
    'rejected' => 'Avvisad',
    'reject_quote' => 'Avvisa offert',
    'reject_quote_confirmation' => 'Är du säker på att du vill avvisa detta citat?',
    'reason' => 'Resonera',
    'enter_reason' => 'Ange en anledning...',
    'notification_invoice_overdue_summary_subject' => 'Sammanfattning av förfallna fakturor: :date',
    'notification_invoice_overdue_summary' => 'Följande fakturor är förfallna:',
    'purge_user_confirmation' => 'Varning! Den här åtgärden kommer att omtilldela alla enheter till kontoägaren och permanent ta bort användaren från alla företag och konton. Är du säker på att du vill fortsätta?',
    'peppol_sending_failed' => 'Skickandet av e-faktura misslyckades!',
    'peppol_sending_success' => 'E-faktura skickad!',
    'auto_generate' => 'Generera automatiskt',
    'mollie_payment_pending' => 'Din betalning väntar. Vänta tills den behandlas. Vi skickar ett e-postmeddelande till dig när den är klar.',
    'over_payment_helper' => 'Valfritt: du kan betala mer än det belopp som visas här. (dvs. dricks, avrunda uppåt)',
    'new_resource' => 'Ny resurs',
    'drop_your_logo_here' => 'Släpp din logotyp här eller klicka för att bläddra',
    'save_to_enable_health_check' => 'Hälsokontrollen kommer att vara tillgänglig efter att gatewayändringarna har sparats.',
    'audit_log' => 'Granskningslogg',
    'clone_to_template' => 'Klona till mall',
    'clone_document_description' => 'Klona till ett nytt dokument',
    'add_signatories' => 'Lägg till undertecknare',
    'authorized_to_sign' => 'Behörig att underteckna',
    'ninja_quote_notification' => 'Citat Signerad Avisering',
    'ninja_invoice_notification' => 'Fakturaundertecknad avisering',
    'ninja_credit_notification' => 'Kreditsignerad avisering',
    'ninja_purchase_order_notification' => 'Meddelande om signerad inköpsorder',
    'email_client_when_quote_signed_description' => 'E-postklient när offerten är signerad',
    'email_client_when_invoice_signed_description' => 'E-postklient när fakturan är signerad',
    'email_client_when_credit_signed_description' => 'E-postklient när kredit är signerad',
    'email_vendor_when_purchase_order_signed_description' => 'Skicka e-post till leverantören när inköpsordern är signerad',
    'custom_document_completed' => 'Anpassat dokument slutfört',
    'email_client_when_custom_document_completed' => 'E-postklient när ett anpassat dokument har signerats',
    'sender' => 'Avsändare',
    'create_template' => 'Skapa mall',
    'edit_template' => 'Redigera mall',
    'delete_template' => 'Ta bort mall',
    'template_created' => 'Mall skapad',
    'template_updated' => 'Mallen uppdaterad',
    'template_deleted' => 'Mall borttagen',
    'template_name' => 'Mallnamn',
    'template_description' => 'Mallbeskrivning',
    'document_type' => 'Dokumenttyp',
    'document_type_description' => 'Välj dokumenttyp för att konfigurera signaturer',
    'new_signatory' => 'Ny undertecknare',
    'signatory' => 'Undertecknare',
    'invoice_ninja_template_description' => 'Anpassa placeringen av signaturer på Invoice Ninja-dokument som fakturor, offerter etc.',
    'activity_159' => 'Fakturan :invoice för :client har signerats',
    'activity_160' => 'Offert :quote för :client undertecknades',
    'activity_161' => 'Kreditera :credit för :client signerades.',
    'activity_162' => 'Inköpsorder :purchase_order för :vendor har signerats',
    'activity_163' => 'Anpassat dokument: dokument för :client signerades',
    'activity_164' => 'QuickBooks-synkroniseringen misslyckades. :notes',
    'activity_165' => 'QuickBooks-synkroniseringen lyckades. :notes',
    'create_your_own' => 'Skapa din egen',
    'create_your_own_description' => 'Skapa din egen mall med ditt eget PDF-dokument för uppladdning',
    'new_template_description' => 'Välj en av våra färdiga mallar för att komma igång, t.ex. sekretessavtal, försäljningsavtal etc.',
    'choose_template_type' => 'Välj vilken typ av mall du vill skapa',
    'template' => 'Mall',
    'templates' => 'Mallar',
    'new_template' => 'Ny mall',
    'user_limit_reached' => 'Behöver du fler användare? Uppgradera ditt abonnemang!',
    'requires_approval' => 'Kräver godkännande',
    'document_viewed_notification' => 'Aviseringar om visade dokument',
    'document_created_notification' => 'Aviseringar om skapade dokument',
    'document_sent_notification' => 'Aviseringar om skickade dokument',
    'document_signed_notification' => 'Aviseringar om undertecknade dokument',
    'document_completed_notification' => 'Aviseringar om slutförda dokument',
    'document_rejected_notification' => 'Avvisade dokumentmeddelanden',
    'document_voided_notification' => 'Aviseringar om ogiltigförklaring av dokument',
    'document_expired_notification' => 'Aviseringar om utgångna dokument',
    'document_created' => 'Dokument skapat',
    'template_loaded' => 'Mallen laddad',
    'select_user_or_client' => 'Välj användare eller klient',
    'docuninja_quota_available_but_no_users' => 'Lägg först till en användare i Invoice Ninja och ge dem sedan åtkomst till DocuNinja här.',
    'send_confirmation' => 'Skicka bekräftelse',
    'document_queued_for_sending' => 'Dokument i kö för sändning',
    'document_voided' => 'Dokument ogiltigförklarat',
    'view_document' => 'Visa dokument',
    'make_template' => 'Skapa mall',
    'use_template' => 'Använd mall',
    'map_signatories' => 'Kartundertecknare',
    'map_signatories_instructions' => 'Tilldela undertecknarna till mallen',
    'total_signatories' => 'Totalt antal undertecknare',
    'mapped' => 'Kartlagd',
    'docuninja_splash_message' => 'Laddar DocuNinja...',
    'docuninja_contact_admin_for_access' => 'Kontakta din administratör för åtkomst till DocuNinja.',
    'void' => 'Ogiltig',
    'invitation_signatory_help' => 'Dokument signeras sekventiellt, efter att den första undertecknaren har undertecknat kan nästa undertecknare skriva under.',
    'timeline' => 'Tidslinje',
    'cloned_document' => 'Dokument klonat',
    'voided_document' => 'Dokument ogiltigförklarat',
    'voided' => 'Ogiltigförklarad',
    'archive_document_description' => 'Är du säker på att du vill arkivera det här dokumentet?',
    'restore_document_description' => 'Är du säker på att du vill återställa det här dokumentet?',
    'delete_document_description' => 'Är du säker på att du vill ta bort det här dokumentet?',
    'document_archived' => 'Dokument arkiverat',
    'document_restored' => 'Dokument återställt',
    'document_deleted' => 'Dokument borttaget',
    'sign_now' => 'Skriv under nu',
    'signed_document' => 'Undertecknat dokument',
    'tour_document_upload' => 'För att börja signera, ladda upp ditt dokument här. Dra och släpp dina filer till det här området.',
    'tour_signatory_selector' => 'Detta är väljaren för undertecknare. Använd den för att hantera undertecknarna för ditt dokument. Välj en undertecknare för att fortsätta.',
    'tour_continue_select_signatory' => 'Fortsätt genom att välja en undertecknare.',
    'tour_toolbox_description' => 'Till höger finns verktygslådan. Använd den för att lägga till fält och element som undertecknare kan interagera med. Signaturfältet är redan valt. Klicka för att fortsätta.',
    'tour_document_canvas' => 'Detta är din dokumentarbetsyta. Placera och håll fälten för dina undertecknare här.',
    'tour_save_document' => 'När du är klar klickar du här för att spara dokumentet.',
    'create_signature' => 'Skapa signatur',
    'signature_name' => 'Underskrift Namn',
    'close_tab' => 'Stäng fliken',
    'sign' => 'Tecken',
    'add_open_exchange' => 'Lägg till Open Exchange-nyckel',
    'all_entity_types_created' => 'Alla entitetstyper skapade',
    'amount_must_be_greater_than_zero' => 'Beloppet måste vara större än noll',
    'autobill_failure' => 'Automatisk fakturering misslyckades',
    'autobill_success' => 'Automatisk fakturering lyckades',
    'available' => 'Tillgänglig',
    'blueprint' => 'Plan',
    'capabilities' => 'Förmågor',
    'card_holder_help' => 'Kortinnehavarens namn',
    'cards' => 'Kort',
    'charts' => 'Diagram',
    'company_logo' => 'Företagslogotyp',
    'create_client_or_user' => 'Skapa klient eller användare',
    'create_docuninja_account' => 'Skapa DocuNinja-konto',
    'create_recurring_expense' => 'Skapa återkommande utgifter',
    'create_recurring_invoice' => 'Skapa återkommande faktura',
    'create_recurring_quote' => 'Skapa återkommande offert',
    'create_subscription' => 'Skapa prenumeration',
    'create_user' => 'Skapa användare',
    'created' => 'Skapad',
    'creating' => 'Skapande',
    'credit_signed_notification' => 'Kreditsignerad avisering',
    'customize_cards' => 'Anpassa kort',
    'datatable' => 'Datatabell',
    'date_must_be_after_previous_schedule' => 'Datumet måste vara efter föregående schema',
    'default_checkbox_label' => 'Standardkryssruta',
    'default_multiselect_label' => 'Standardval för flera alternativ',
    'default_radio_group_label' => 'Standardradiogrupp',
    'default_select_label' => 'Standardval',
    'delete_document' => 'Ta bort dokument',
    'delete_docuninja_document' => 'Ta bort fil',
    'delete_docuninja_document_confirmation' => 'Är du säker på att du vill ta bort den här filen från dokumentet?',
    'delete_subscription' => 'Ta bort prenumeration',
    'disable_docuninja' => 'Inaktivera DocuNinja',
    'document_not_found' => 'Dokumentet hittades inte',
    'docuninja_access_grant_failed' => '',
    'docuninja_access_granted_successfully' => 'DocuNinja-åtkomst beviljad',
    'download_signed_document' => 'Ladda ner signerat dokument',
    'e_expense_created' => 'E-utgift skapad',
    'edit_rule' => 'Redigera regel',
    'einvoice_delivery_failure' => 'Leverans av e-faktura misslyckades',
    'einvoice_delivery_success' => 'Leverans av e-faktura lyckades',
    'einvoice_sent' => 'E-faktura skickad',
    'element' => 'Element',
    'email_invoice_failed' => 'E-postmeddelandet misslyckades att skickas',
    'empty_checkbox_label' => 'Tom kryssruta',
    'end_of_month' => 'Slutet av månaden',
    'error_fetching_pricing' => 'Fel vid hämtning av prissättning',
    'exchange_rate_not_enabled' => 'Växelkursen är inte aktiverad',
    'failed_payment' => 'Betalningen misslyckades',
    'field_is_required' => 'Fältet är obligatoriskt',
    'generate' => 'Generera',
    'google_drive' => 'Google Drive',
    'initials' => 'Initialer',
    'initials_description' => 'Beskrivning av initialer',
    'invalid_state' => 'Ogiltigt tillstånd',
    'invoice_signed_notification' => 'Avisering om fakturasignering',
    'link_copied' => 'Länk kopierad',
    'make_template_description' => 'Skapa din egen mall med ditt eget PDF-dokument för uppladdning',
    'manage' => 'Hantera',
    'multiselect_needs_two_options' => 'Flerval behöver två alternativ',
    'no_cards_selected' => 'Inga kort valda',
    'no_templates_found' => 'Inga mallar hittades',
    'nordigen' => 'Nordigen',
    'pages' => 'Sidor',
    'passed' => 'Godkänd',
    'payment_emailed' => 'Betalning skickad via e-post',
    'payment_successful' => 'Betalningen lyckades',
    'pdf_password_required' => 'PDF-lösenord krävs',
    'pending_approval' => 'Väntar på godkännande',
    'please_select_at_least_one_user' => 'Välj minst en användare',
    'please_select_plan' => 'Välj ett abonnemang',
    'please_select_signer' => 'Vänligen välj en undertecknare',
    'proformal_invoices' => 'Proformafakturor',
    'purchase_order_signed_notification' => 'Meddelande om signerad inköpsorder',
    'queue' => 'Kö',
    'quote_field' => 'Offertfält',
    'quote_signed_notification' => 'Citat signerad anmälan',
    'radio_needs_two_options' => 'Radion behöver två alternativ',
    'recipient' => 'Mottagare',
    'redirect' => 'Dirigera om',
    'refundable' => 'Återbetalningsbar',
    'remove_invitations' => 'Ta bort inbjudningar',
    'removing' => 'Tar bort',
    'requirements' => 'Krav',
    'restore_subscription' => 'Återställ prenumeration',
    'sales_above_threshold' => 'Försäljning över tröskelvärdet',
    'save_to_add_locations' => 'Spara för att lägga till platser',
    'saving' => 'Sparande',
    'select_design' => 'Välj design',
    'select_needs_two_options' => 'Välj behöver två alternativ',
    'sending' => 'Sändning',
    'setting_up' => 'Konfigurera',
    'setup_company' => 'Installationsföretag',
    'signature-placeholder' => 'Platshållare för signatur',
    'signature:font-updated' => 'Signaturteckensnitt uppdaterat',
    'signature_description' => 'Beskrivning av signaturen',
    'snappdf_not_enabled' => 'Snappdf är inte aktiverat',
    'start_signing' => 'Börja signera',
    'successfully_signed_document' => 'Dokumentet har signerats',
    'swap_signatory' => 'Bytessignatur',
    'template_details' => 'Malldetaljer',
    'tips_and_notes' => 'Tips och anteckningar',
    'too_many_files' => 'För många filer',
    'type_signature' => 'Skriv signatur',
    'untitled_document' => 'Namnlöst dokument',
    'untitled_template' => 'Namnlös mall',
    'update_recurring_expense' => 'Uppdatera återkommande utgifter',
    'update_recurring_invoice' => 'Uppdatera återkommande faktura',
    'update_recurring_quote' => 'Uppdatera återkommande offert',
    'update_subscription' => 'Uppdatera prenumeration',
    'update_user' => 'Uppdatera användare',
    'upgrade_account_message' => 'Meddelande om att uppgradera kontot',
    'upgrade_now' => 'Uppgradera nu',
    'upgrade_plan_docuninja' => 'Uppgradera ditt abonnemang för att aktivera DocuNinja',
    'use_signature' => 'Använd signatur',
    'use_snappdf' => 'Använd snappdf',
    'user_note' => 'Användarinformation',
    'vendor_notification_email' => 'E-postmeddelande för leverantörsavisering',
    'void_document_description' => 'Beskrivning av ogiltigt dokument',
    'voided_payment' => 'Betalning ogiltigförklarad',
    'welcome_to_docuninja' => 'Välkommen till DocuNinja',
    'yodlee' => 'Yodlee',
    'location_name' => 'Platsnamn',
    'quote_rejected' => 'Citat avvisat',
    'e_invoice_received_notification' => 'Avisering om mottagen e-faktura',
    'e_invoice_received_notification_help' => 'Skicka ett e-postmeddelande när en e-faktura har mottagits',
    'location_field' => 'Platsfält',
    'access_key' => 'Åtkomstnyckel',
    'payment_type_FPX' => 'FPX',
    'payment_type_Stripe Bank Transfer' => 'Stripe banköverföring',
    'activity_166' => 'Användaren :notes rensades av :user',
    'purged_user' => 'Användaren har rensats',
    'quickbooks_connect_description' => 'Anslut ditt QuickBooks-konto till Invoice Ninja för att automatiskt synkronisera dina transaktioner och fakturor.',
    'sync_direction_description' => 'Dessa inställningar avgör hur Invoice Ninja synkroniseras med QuickBooks.',
    'sync_direction_none_help' => 'Fakturaninja kommer inte att synkronisera några data till eller från QuickBooks.',
    'sync_direction_pull_help' => 'Fakturaninja hämtar data från QuickBooks.',
    'sync_direction_push_help' => 'Fakturaninja skickar data till QuickBooks.',
    'sync_direction_bidirectional_help' => 'Faktura Ninja kommer att både hämta och hämta data till QuickBooks.',
    'sync_settings' => 'Synkroniseringsinställningar',
    'realm_id' => 'QB Realm-ID',
    'default_income_account' => 'Standardinkomstkonto',
    'automatic_taxes' => 'Automatiska skatter',
    'automatic_taxes_help' => 'När automatiska skatter (AST) är aktiverade i Quickbooks skapar Invoice Ninja först fakturan i Quickbooks och hämtar sedan den fullständiga fakturan tillbaka till Invoice Ninja.',
    'pull' => 'Dra',
    'push' => 'Tryck',
    'bidirectional' => 'Dubbelriktad',
    'sync_started' => 'Synkroniseringen har startat',
    'quickbooks_read_only_data' => 'QuickBooks inkomstkonton och lagrade skattesatser',
    'hide_peppol_sent_status' => 'Dölj Peppols skickade status',
    'quickbooks_requires_reauth' => 'QuickBooks kräver omautentisering',
    'quickbooks_requires_reauth_body' => 'Din QuickBooks-anslutning har upphört att gälla och kräver återautentisering. Logga in på administratörsportalen och återanslut ditt QuickBooks-konto. Vi skickar dig detta meddelande dagligen tills problemet är löst.',
    'crop_logo' => 'Beskär logotyp',
    'passkey' => 'Lösenord',
    'login_with_passkey' => 'Logga in med en lösenkod',
    'manage_passkeys' => 'Hantera lösenord',
    'last_used' => 'Senast använd',
    'unapplied_payments' => 'Ej tillämpade betalningar',
    'debit' => 'Debitera',
    'auto_convert_credit_help' => 'Länka eller skapa automatiskt en betalning som matchar dessa regler.',
    'clone_client_description' => 'Detta klonar klienten till en ny klientpost.',
    'invalid_id_number_format' => 'Ogiltigt ID-nummerformat',
    'invalid_vat_number_format' => 'Ogiltigt format för momsregistreringsnummer',
    'invalid_routing_id_format' => 'Ogiltigt routing-ID-format',
    'invalid_id_number_checkdigit' => 'Ogiltigt ID-nummer: fel i kontrollsiffran, kontrollera att numret är korrekt',
    'invalid_vat_number_checkdigit' => 'Ogiltigt momsregistreringsnummer: fel i kontrollsiffran, kontrollera att numret är korrekt',
    'invalid_routing_id_checkdigit' => 'Ogiltigt routing-ID: fel i kontrollsiffran, kontrollera att numret är korrekt',
    'sign_the_document' => 'Signera dokumentet',
    'client_not_found_on_peppol_network' => 'Klienten kunde inte identifieras i PEPPOL-nätverket.',
    'too_many_requests' => 'För många förfrågningar',
    'custom_text_with_formatting' => 'Anpassad text med formatering',
    'client_name_and_address' => 'Klientens namn och adress',
    'bill_to' => 'Fakturera till:',
    'entity_details' => 'Nummer, datum, förfallodatum, belopp, saldo',
    'product_line_items_with_columns' => 'Produktrader med kolumner',
    'task_line_items_with_columns' => 'Uppgiftsradposter med kolumner',
    'divider_line' => 'Horisontell avgränsare',
    'signature_line' => 'Signaturområde',
    'authorized_signature' => 'Auktoriserad underskrift',
    'essential' => 'Grundläggande',
    'public_notes_will_appear_here' => 'Offentliga anteckningar kommer att visas här',
    'footer_will_appear_here' => 'Sidfoten kommer att visas här',
    'terms_will_appear_here' => 'Villkoren kommer att visas här',
    'sepa_qr' => 'SEPA QR',
    'swiss_qr' => 'Schweizisk QR',
    'spc_qr' => 'SPC QR-kod',
    'verifactu_qr' => 'Verifiera QR',
    'payment_qr' => 'Betalnings-QR',
    'download_json' => 'Ladda ner JSON',
    'copy_block_to_clipboard' => 'Kopiera block till urklipp',
    'duplicate_block' => 'Duplicera block',
    'delete_block' => 'Ta bort block',
    'height_placeholder_example' => 't.ex. 40px',
    'select_starting_point_for_invoice_design' => 'Välj en utgångspunkt för din fakturadesign',
    'no_templates_found_in_category' => 'Inga mallar hittades i den här kategorin',
    'preview_uses_sample_data' => 'Förhandsgranskningen använder exempeldata',
    'download_html' => 'Ladda ner HTML',
    'blocks_in_design' => 'block i design',
    'actual_invoices_use_real_data' => 'Fakturorna kommer att använda riktiga kunder och fakturauppgifter.',
    'cloned_client' => 'Klienten har klonats',
    'update_tax_details' => 'Uppdatera skatteuppgifter',
    'cc_only' => 'Endast CC',
    'e_invoice_forward_email' => 'PEPPOL vidarebefordringstjänst för e-post',
    'e_invoice_forward_email_help' => 'Vidarebefordrade e-fakturor till en tredjepartsbehandlingstjänst som Yuki eller WinAuditor',
    'skip_automatic_email_with_peppol' => 'Inaktivera e-post när den skickas via PEPPOL',
    'skip_automatic_email_with_peppol_help' => 'Om aktiverat kommer fakturor som skickas via PEPPOL-nätverket inte att skickas till klienten via e-post.',
    'web_session_timeout_help' => 'Tid en webbläsarsession förblir aktiv innan den loggas ut.',
    'password_timeout_help' => 'Tid innan ett administratörslösenord måste anges på nytt.',
    'invoice_status_paid' => 'Fakturan har just betalats! Posten har nu uppdaterats.',
    'attach_audit_log_to_completed_email' => 'Bifoga granskningslogg till slutfört e-postmeddelande',
    'attach_audit_log_to_completed_email_help' => 'Om den är aktiverad bifogas granskningsloggen till e-postmeddelandet om att det signerade dokumentet är slutfört.',
    'e_expense_forward_email' => 'E-posttjänst för vidarebefordran av utgifter',
    'e_expense_forward_email_help' => 'Vidarebefordra mottagna e-utgifter till en tredjepartsbehandlingstjänst som Yuki eller WinAuditor',
    'regenerate_token' => 'Regenerera token',
    'token_regenerated' => 'Token har regenererats',
    'token_regeneration_failed' => 'Tokenregenerering misslyckades',
    'show_header' => 'Visa rubrik',
    'select_a_component_to_edit_properties' => 'Välj en komponent att redigera',
    'drag_and_drop_to_add' => 'Dra och släpp för att lägga till',
    'max_width' => 'Maxbredd',
    'max_height' => 'Maxhöjd',
    'alignment' => 'Inriktning',
    'object_fit' => 'Objektanpassning',
    'padding' => 'Stoppning',
    'fix_overlaps' => 'Åtgärda överlappningar',
    'spacer' => 'Distans',
    'line_height' => 'Linjehöjd',
    'text_color' => 'Textfärg',
    'font_style' => 'Typsnittsstil',
    'alternate_row_colors' => 'Alternativa radfärger',
    'show_borders' => 'Visa gränser',
    'cell_padding' => 'Cellfyllning',
    'suffix' => 'Ändelse',
    'hide_if_empty' => 'Dölj om tom',
    'qr_code' => 'QR-kod',
    'qr_code_type' => 'QR-kodtyp',
    'label_padding' => 'Mellanrum runt varje etikett.',
    'value_padding' => 'Mellanrum runt varje värde.',
    'label_value_gap' => 'Gap mellan etikett och värde.',
    'row_spacing' => 'Hur mycket vertikalt utrymme som finns mellan varje rad.',
    'value_min_width' => 'Minsta bredd för värden.',
    'restored_template' => 'Mallen har återställts',
    'archived_template' => 'Mallen har arkiverats',
    'deleted_template' => 'Mallen har tagits bort',
    'top' => 'Bästa',
    'table_rows' => 'Rader',
    'style' => 'Stil',
    'widget_defaults' => 'Standardinställningar för widgeten',
    'show_label' => 'Visa etikett',
    'show_label_help' => 'Visa widgetens etikett bredvid dess värde.',
    'widget_border_style' => 'Widgetkantstil',
    'widget_border_style_help' => 'Kantlinjestil för widgetområdet.',
    'widget_border_color' => 'Färg på widgetkanten',
    'widget_border_color_help' => 'Färg på kanten runt widgetområdet.',
    'card_already_exists' => 'Kortet finns redan',
    'income_account' => 'Inkomstkonto',
    'payment_period' => 'Betalningsperiod',
    'payment_period_help' => 'Tillåten tid för betalningsslutförande i sekunder. Godkänt intervall 60–600.',
    'payware_partner_id_label' => 'Partneridentifierare',
    'payware_partner_id_help' => 'Tillhandahålls av payware vid registrering',
    'payware_vpos_id_label' => 'webPOS-identifierare',
    'payware_vpos_id_help' => 'webPOS-identifierare från payware-instrumentpanelen',
    'payware_public_key_help' => 'RSA-nyckel för validering av webhook-signaturer',
    'gateway_onboarding_description' => 'Din betalningsgateway har anslutits. Du kan nu konfigurera betalningsmetoder och ställa in transaktionsgränser eller avgifter.',
    'gateway_onboarding_payment_methods_help' => 'Aktivera eller inaktivera accepterade betalningsmetoder för dina kunder.',
    'gateway_onboarding_limits_fees_help' => 'Ställ in minimi- och maximigränser för transaktioner och konfigurera behandlingsavgifter.',
    'gateway_setup_complete' => 'Gateway-installationen är klar',
    'activity_167' => 'Status för e-faktura :invoice uppdaterad till :notes',
    'peppol_accepted' => 'E-faktura accepterad av mottagaren.',
    'peppol_rejected' => 'E-faktura avvisad av mottagaren.',
    'peppol_partially_paid' => 'E-faktura delvis betald.',
    'peppol_paid' => 'E-faktura betald.',
