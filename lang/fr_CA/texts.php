...
$lang = array(
    ...
    'no_passkeys_registered' => 'Aucune clé d\'accès n\'est enregistrée pour ce compte. Veuillez vous connecter avec votre mot de passe ou enregistrer une clé d\'accès au préalable.',
...
Lorsque les montant apparaîtront sur votre relevé, veuillez revenir sur cette page et cliquez sur "Compléter la vérification" à côté du compte.',
    ...
    'auto_bill_option' => 'Payer automatiquement les factures futures de cette série récurrente ?',
    'lang_Arabic' => 'Arabe',
    'lang_Persian' => 'Persan',
    'lang_Latvian' => 'Letton',
    ...
    'promptpay_instructions' => 'Cliquez sur « Payer maintenant » pour afficher un code QR PromptPay, puis scannez-le avec votre application bancaire thaïlandaise pour finaliser le paiement.',
    ...
    'payments_by_month' => 'Paiements par mois',
    'monthly_breakdown_skipped' => 'Répartition mensuelle omise : la période dépasse 24 mois',
    ...
    'income' => 'Revenu',
    'amount_received_help' => 'Saisissez une valeur si le montant total reçu est PLUS élevé que le montant de la facture, ou lors de l\'enregistrement d\'un paiement sans factures. Sinon, ce champ devrait rester vide.',
    'vendor_phone' => 'Téléphone du fournisseur',
    'mercado_pago' => 'Mercado Pago',
    'mobile_payment' => 'Paiement mobile',
    'awaiting_payment' => 'Paiement en attente',
    'payment_confirmed' => 'Paiement confirmé',
    'payment_expired' => 'Paiement expiré. Essayez à nouveau.',
    'payment_was_not_completed' => 'Paiement non complété. Essayez à nouveau.',
    'no_compatible_app_installed' => 'Si rien ne se produit, vous n\'avez peut-être pas d\'application compatible installée.',
...
Développe automatiquement la section des notes dans le tableau de produits pour afficher plus de lignes.',
    ...
    'end_all_sessions_help' => 'Déconnecte tous les utilisateurs ; nécessite une nouvelle authentification.',
    ...
    'docuninja_grant_access_help' => 'Autoriser l\'accès des utilisateurs d\'Invoice Ninja à DocuNinja',
...
 ',
    ...
    'over_payment_helper' => 'Facultatif : vous pouvez donner plus que le montant indiqué (ex. : pourboire, arrondi)',
    'new_resource' => 'Nouvelle ressource',
    'drop_your_logo_here' => 'Déposer votre logo ici ou cliquez pour charger',
    'save_to_enable_health_check' => 'Le bilan de santé sera disponible après l\'enregistrement des modifications de la passerelle.',
    'audit_log' => 'Journal d\'audit',
    'clone_to_template' => 'Dupliquer vers un modèle',
    'clone_document_description' => 'Dupliquer vers un nouveau document',
    'add_signatories' => 'Ajouter des signataires',
    'authorized_to_sign' => 'Autorisé à signer',
    'ninja_quote_notification' => 'Notification pour soumission signée',
    'ninja_invoice_notification' => 'Notification pour facture signée',
    'ninja_credit_notification' => 'Notification pour crédit signé',
    'ninja_purchase_order_notification' => 'Notification pour bon de commande signé',
    'email_client_when_quote_signed_description' => 'Envoyer un courriel au client lorsque la soumission est signée',
    'email_client_when_invoice_signed_description' => 'Envoyer un courriel au client lorsque la facture est signée',
    'email_client_when_credit_signed_description' => 'Envoyer un courriel au client lorsque le crédit est signé',
    'email_vendor_when_purchase_order_signed_description' => 'Envoyer un courriel au client lorsque le bon de commande est signé',
    ...
    'document_type_description' => 'Sélectionnez le type de document pour configurer les signatures',
    'new_signatory' => 'Nouveau signataire',
    'signatory' => 'Signataire',
    'invoice_ninja_template_description' => 'Personnaliser l\'emplacement des signatures sur les documents Invoice Ninja tels que les factures, soumissions, etc.',
    'activity_159' => 'La facture :invoice pour :client a été signée',
    'activity_160' => 'La soumission :quote pour :client a été signée',
    'activity_161' => 'Le crédit :credit pour :client a été signé',
    'activity_162' => 'Le bon d\'achat :purchase_order pour :vendor a été signé',
    'activity_163' => 'Le document personnalisé :document pour :client a été signé',
    'activity_164' => 'La synchronisation QuickBooks a échoué. :notes',
    'activity_165' => 'La synchronisation QuickBooks a réussi. :notes',
    'create_your_own' => 'Créer le vôtre',
    'create_your_own_description' => 'Créez votre propre modèle en téléchargeant votre document PDF',
    'new_template_description' => 'Sélectionnez l\'un de nos modèles prédéfinis pour commencer (ex : accord de confidentialité, contrat de vente, etc.).',
    'choose_template_type' => 'Sélectionnez le type de modèle que vous souhaitez créer',
    'template' => 'Modèle',
    'templates' => 'Modèles',
    'new_template' => 'Nouveau modèle',
    'user_limit_reached' => 'Besoin de plus d\'utilisateurs ? Améliorez votre forfait !',
    'requires_approval' => 'Requiert une approbation',
    'document_viewed_notification' => 'Notifications : document vu',
    'document_created_notification' => 'Notifications : document créé',
    'document_sent_notification' => 'Notifications : document envoyé',
    'document_signed_notification' => 'Notifications : document signé',
    'document_completed_notification' => 'Notifications : document complété',
    'document_rejected_notification' => 'Notifications : document rejeté',
    'document_voided_notification' => 'Notifications : document annulé',
    'document_expired_notification' => 'Notifications : document expiré',
    'document_created' => 'Document créé',
    'template_loaded' => 'Modèle chargé',
    'select_user_or_client' => 'Sélectionnez un utilisateur ou un client',
    'docuninja_quota_available_but_no_users' => 'Ajoutez d\'abord l\'utilisateur dans Invoice Ninja, puis accordez-lui l\'accès à DocuNinja ici.',
    ...
    'document_queued_for_sending' => 'Document mis en attente d\'envoi',
    'document_voided' => 'Document annulé',
    'view_document' => 'Visualiser le document',
    'make_template' => 'Produire un modèle',
    'use_template' => 'Utiliser un modèle',
    'map_signatories' => 'Faire correspondre les signataires',
    'map_signatories_instructions' => 'Assigner les signataires au modèle',
    'total_signatories' => 'Nombre total de signataires',
    'mapped' => 'Assigné',
    'docuninja_splash_message' => 'DocuNinja en chargement...',
    'docuninja_contact_admin_for_access' => 'Prenez contact avec votre admin pour l\'accès au DocuNinja.',
    'void' => 'Annulé',
    'invitation_signatory_help' => 'Les documents sont signés de manière séquentielle : une fois que le premier signataire a signé, le suivant pourra apposer sa signature.',
    'timeline' => 'Échéancier',
    'cloned_document' => 'Document dupliqué',
    'voided_document' => 'Document annulé',
    'voided' => 'Annulé',
    'archive_document_description' => 'Êtes-vous certain de vouloir archiver ce document ?',
    'restore_document_description' => 'Êtes-vous certain de vouloir restaurer ce document ?',
    'delete_document_description' => 'Êtes-vous certain de vouloir supprimer ce document ?',
    ...
    'tour_document_upload' => 'Pour commencer à signer, téléchargez votre document ici. Glissez et déposez vos fichiers dans cette zone.',
    ...
    'tour_continue_select_signatory' => 'Continuez en sélectionnant un signataire.',
    ...
    'amount_must_be_greater_than_zero' => 'Le montant doit être plus grand que zéro',
    'autobill_failure' => 'Autofacturation échouée',
    'autobill_success' => ' Autofacturation réussie',
    ...
    'create_docuninja_account' => 'Créer un compte DocuNinaj',
    'create_recurring_expense' => 'Créer une dépense récurrrente',
    'create_recurring_invoice' => 'Créer une facture récurrente',
    'create_recurring_quote' => 'Créer une soumission récurrente',
    'create_subscription' => 'Créer un abonnement',
    'create_user' => 'Créer un utilisateur',
    'created' => 'Créé',
    'creating' => 'En cours de création',
    'credit_signed_notification' => 'Notification de crédit signé',
    'customize_cards' => 'Personnaliser les cartes',
    'datatable' => 'Tableau de données',
    'date_must_be_after_previous_schedule' => 'La date doit être postérieure à la programmation précédente',
    ...
    'docuninja_access_granted_successfully' => 'L\'accès à DocuNinja e été accordé',
    ...
    'einvoice_delivery_success' => 'La facture électronique a été envoyée',
    'einvoice_sent' => 'Facture électronique envoyée',
    'element' => 'Élément',
    'email_invoice_failed' => 'L\'envoi du message courriel a échoué',
    ...
    'make_template_description' => 'Créez votre propre modèle en utilisant votre propre document PDF à téléverser',
    'manage' => 'Gérer',
    ...
    'pages' => 'Pages',
    'passed' => 'Passés',
    'payment_emailed' => 'Paiement envoyé',
    ...
    'please_select_plan' => 'Veuillez sélectionner un plan',
    'please_select_signer' => 'Veuillez sélectionner un signataire',
    'proformal_invoices' => 'Factures pro forma',
    'purchase_order_signed_notification' => 'Notification de bon de commande signé',
    'queue' => 'File d\'attente',
    'quote_field' => 'Champ de soumission',
    'quote_signed_notification' => 'Notification de soumission signée',
    'radio_needs_two_options' => 'Le bouton radio a besoin de deux options',
    'recipient' => 'Destinataire',
    'redirect' => 'Rediriger',
    'refundable' => 'Remboursable',
    'remove_invitations' => 'Retirer les invitations',
    'removing' => 'Retrait',
    ...
    'setup_company' => 'Configurer l\'entreprise',
    ...
    'successfully_signed_document' => 'le document a été signé',
    'swap_signatory' => 'Changement de signataire',
    ...
    'update_recurring_quote' => 'Mise à jour de la soumission récurrente',
    'update_subscription' => 'Mise à jour de l\'abonnement',
    ...
    'quote_rejected' => 'Soumission refusée',
    ...
    'location_field' => 'Champ pour emplacement',
    ...
    'sync_direction_description' => 'Ces paramètres déterminent la manière dont Invoice Ninja se synchronise avec QuickBooks.',
    'sync_direction_none_help' => 'Invoice Ninja ne synchronisera aucune donnée vers ou depuis QuickBooks.',
    'sync_direction_pull_help' => 'Invoice Ninja récupérera les données depuis QuickBooks.',
    'sync_direction_push_help' => 'Invoice Ninja enverra les données vers QuickBooks.',
    'sync_direction_bidirectional_help' => 'Invoice Ninja va à la fois récupérer et envoyer des données vers QuickBooks.',
    'sync_settings' => 'Synchronisation des paramètres',
    'realm_id' => 'ID Realm QB',
    'default_income_account' => 'Compte de revenus par défaut',
    'automatic_taxes' => 'Taxes automatiques',
    'automatic_taxes_help' => 'Lorsque les taxes automatiques (AST) sont activées dans QuickBooks, Invoice Ninja crée d\'abord la facture dans QuickBooks, puis récupère la facture finalisée dans Invoice Ninja.',
    'pull' => 'Récupérer',
    'push' => 'Envoyer',
    'bidirectional' => 'Bidirectionnel',
    'sync_started' => 'Synchronisation démarrée',
    'quickbooks_read_only_data' => 'Comptes de revenus et taux de taxe enregistrés dans QuickBooks',
    'hide_peppol_sent_status' => 'Masquer l\'état d\'envoi Peppol',
    'quickbooks_requires_reauth' => 'QuickBooks nécessite une réauthentification.',
    'quickbooks_requires_reauth_body' => 'Votre connexion à QuickBooks a expiré et nécessite une réauthentification. Veuillez vous connecter au portail administrateur pour reconnecter votre compte QuickBooks. Cette notification vous sera envoyée quotidiennement jusqu’à ce que le problème soit résolu.',
    'crop_logo' => 'Roger le logo',
    'passkey' => 'Clé d\'accès',
    ...
    'product_line_items_with_columns' => 'Lignes de produits avec colonnes',
    'task_line_items_with_columns' => 'Lignes de tâches avec colonnes',
    'divider_line' => 'Séparateur horizontal',
    'signature_line' => 'Zone de signature',
    'authorized_signature' => 'Signature autorisée',
    'essential' => 'Essentiel',
    'public_notes_will_appear_here' => 'Les notes publiques s\'afficheront ici',
    'footer_will_appear_here' => 'Le pied de page s\'affichera ici',
    'terms_will_appear_here' => 'Les conditions s\'afficheront ici',
    'sepa_qr' => 'Code QR SEPA',
    'swiss_qr' => 'Code QR Swiss',
    'spc_qr' => 'Code QR SPC',
    'verifactu_qr' => 'Code QR Verifactu',
    'payment_qr' => 'Code QR de paiement',
    ...
    'height_placeholder_example' => 'p. ex., 40px',
    'select_starting_point_for_invoice_design' => 'Sélectionnez un point de départ pour la conception de votre facture',
    ...
    'actual_invoices_use_real_data' => 'Les factures réelles utiliseront les données réelles du client et de la facture',
    ...
    'e_invoice_forward_email_help' => 'Transfère les factures électroniques envoyées vers un service de traitement tiers comme Yuki ou WinAuditor.',
    ...
    'web_session_timeout_help' => 'Délai d\'expiration de la session avant déconnexion.',
    'password_timeout_help' => 'Temps avant qu\'une nouvelle saisie du mot de passe administrateur ne soit requise.',
    'invoice_status_paid' => 'Facture payée avec succès. Mise à jour de la fiche effectuée.',
    'attach_audit_log_to_completed_email' => 'Joindre le journal d\'audit à l\'e-mail de confirmation',
    'attach_audit_log_to_completed_email_help' => 'Si activé, le log d\'audit sera annexé au courriel envoyé une fois le document signé.',
    'e_expense_forward_email' => 'Service de transfert de frais par e-mail',
    'e_expense_forward_email_help' => 'Transfère les notes de frais électroniques reçues vers un service de traitement tiers comme Yuki ou WinAuditor.',
    'regenerate_token' => 'Régénérer le jeton',
    'token_regenerated' => 'Le jeton a été régénéré',
    'token_regeneration_failed' => 'La régénération du jeton a échoué',
    'show_header' => 'Afficher l\'en-tête',
    'select_a_component_to_edit_properties' => 'Sélectionner un composant.',
    'drag_and_drop_to_add' => 'Glisser-déposer pour ajouter',
    'max_width' => 'Largeur max',
    'max_height' => 'Hauteur max',
    'alignment' => 'Alignment',
    'object_fit' => 'Object Fit',
    'padding' => 'Marge interne',
    'fix_overlaps' => 'Ajuster les superpositions',
    'spacer' => 'Espaceur ',
    'line_height' => 'Interligne',
    'text_color' => 'Couleur du texte',
    'font_style' => 'Style de fonte',
    'alternate_row_colors' => 'Couleurs de rangées alternatives',
    'show_borders' => 'Afficher les bordures',
    'cell_padding' => 'Marge interne de cellule',
    'suffix' => 'Suffixe',
    'hide_if_empty' => 'Masquer si vide',
    'qr_code' => 'Code QR',
    'qr_code_type' => 'Type de code QR',
    'label_padding' => 'Espace autour de chaque étiquette.',
    'value_padding' => 'Espace autour de chaque valeur.',
    'label_value_gap' => 'Espacement entre l\'étiquette et la valeur',
    'row_spacing' => 'Espace vertical entre chaque ligne.',
    'value_min_width' => 'Largeur minimale pour les valeurs',
    'restored_template' => 'Le modèle a été restauré',
    'archived_template' => 'Le modèle a été archivé',
    'deleted_template' => 'Le modèle a été supprimé',
    'top' => 'Haut',
    'table_rows' => 'Rangées',
    'style' => 'Style',
    ...
    'widget_border_style_help' => 'Style de border de la zone du widget.',
    'widget_border_color' => 'Couleur de bordure du widget',
    'widget_border_color_help' => 'Couleur de bordure autour de la zone du widget.',
    'card_already_exists' => 'Carte déjà existante',
    'income_account' => 'Compte de revenu',
    'payment_period' => 'Période de paiement',
    'payment_period_help' => 'Délai imparti pour finaliser le paiement (en secondes). Plage autorisée : 60 - 600.',
    'payware_partner_id_label' => 'Identifiant de partenaire',
    'payware_partner_id_help' => 'Fourni par Payware lors de l\'inscription.',
    ...
    'server_not_reachable' => 'Serveur inaccessible. Vérifiez votre connexion Internet et réessayez plus tard.',
    'connecting_calendar' => 'Connexion à votre calendrier…',
    ...
    'calendar_handoff_expired' => 'Lien de connexion expiré',
    'calendar_handoff_expired_body' => 'Le lien de connexion n\'est plus valide. Veuillez relancer la connexion.',
    'calendar_handoff_invalid' => 'Impossible de terminer la connexion',
    'calendar_handoff_invalid_body' => 'Une erreur est survenue lors de la validation de la connexion. Veuillez réessayer.',
    'calendar_connect_failed' => 'Échec de la connexion au calendrier',
    'calendar_connect_failed_body' => 'Nous n\'avons pas pu terminer la connexion à votre calendrier. Veuillez réessayer.',
    ...
    'project_tags' => 'Étiquettes de projet',
    'created_tag' => 'Étiquette créée avec succès',
    'updated_tag' => 'Étiquette mise à jour avec succès',
    'archived_tag' => 'Étiquette archivée avec succès',
    'restored_tag' => 'Étiquette restaurée avec succès',
    'deleted_tag' => 'Étiquette supprimée avec succès',
    'e_reporting_enabled' => 'Télé-déclaration activée',
    'ten_day_reporting' => 'Déclaration tous les 10 jours',
    'monthly_reporting' => 'Déclaration mensuelle',
    'ten_day_reporting_help' => 'Déclarer les transactions de la période en cours par tranches de 10 jours.',
    'monthly_reporting_help' => 'Déclarer les transactions de la période en cours par tranches mensuelles.',
    'quickbooks_deposit_disabled_warning' => 'Les dépôts sont désactivés dans votre compte QuickBooks connecté, ce document ne sera pas synchronisé avec QuickBooks si un dépôt est présent.',
    'tour_template_signatory_swap' => 'Ce document a été créé à partir de votre modèle. Utilisez le menu déroulant pour remplacer le signataire temporaire par un véritable contact client ou utilisateur.',
    'tour_template_save_document' => 'Cliquez ici pour enregistrer vos modifications sur le document.',
    'tour_template_send_document' => 'Lorsque vous êtes prêt, cliquez ici pour envoyer le document à vos signataires.',
    ...
    'email_invalid' => 'Le format du courriel n\'est pas valide.',
    'email_validation_help' => 'Validation de l\'adresse courriel : doit être un format d\'adresse courriel valide',
    ...
    'commas_not_allowed' => 'Les virgules ne sont pas autorisées.',
);
