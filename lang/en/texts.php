...
$LANG = array(
    ...
    'payment_provider_paymenttext' => '(customer) Invoice :invoicenumber for :amount for client :client',
    'payment_prvoder_paymenttext_without_invoice' => '(customer) Payment with no invoice for amount :amount for client :client',
    'payment_provider_paymenttext_tokenbilling' => '(tokenbilling) Invoice :invoicenumber for :amount for client :client',
    'payment_prvoder_paymenttext_without_invoice_tokenbilling' => '(tokenbilling) Payment with no invoice for amount :amount for client :client',
    'stripe_error_rate_limit' => 'Too many requests made to the API too quickly',
    'stripe_error_invalid_request' => 'Invalid parameters were supplied to Stripe\'s API',
    'stripe_error_authentication_failed' => 'Authentication with Stripe\'s API failed',
    'stripe_error_api_error' => 'Network communication with Stripe failed',
    'stripe_error_register_apple_pay_domain' => 'Unable to register Domain with Apple Pay',
    'payment_provider_failed_process_payment' => 'Failed to process the payment.',
