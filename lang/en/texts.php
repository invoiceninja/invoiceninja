...
$lang = array(
    ...
    'enablebanking_handler_subtitle' => 'Bank account authentication. Selecting your financial institution to complete the request with your account credentials.',
    'enablebanking_handler_error_heading_unknown' => 'An error has occurred',
    'enablebanking_handler_error_contents_unknown' => 'An unknown error has occurred! Reason:',
    'enablebanking_handler_error_heading_token_invalid' => 'Invalid Token',
    'enablebanking_handler_error_contents_token_invalid' => 'The provided token was invalid. Contact support for help, if this issue persists.',
    'enablebanking_handler_error_heading_account_config_invalid' => 'Missing Credentials',
    'enablebanking_handler_error_contents_account_config_invalid' => 'Invalid or missing credentials for EnableBanking Bank Account Data. Contact support for help, if this issue persists.',
    'enablebanking_handler_error_heading_not_available' => 'Not Available',
    'enablebanking_handler_error_contents_not_available' => 'Feature unavailable, Enterprise Plan only.',
    'enablebanking_handler_error_heading_aspsps_not_available' => 'Not Available',
    'enablebanking_handler_error_contents_aspsps_not_available' => 'No financial institutions are available.',
    'enablebanking_handler_error_heading_aspsp_invalid' => 'Invalid Financial Institution',
    'enablebanking_handler_error_contents_aspsp_invalid' => 'The selected financial institution is invalid or no longer available.',
    'enablebanking_handler_error_heading_ref_invalid' => 'Invalid Reference',
    'enablebanking_handler_error_contents_ref_invalid' => 'EnableBanking did not provide a valid reference. Please run flow again and contact support, if this issue persists.',
    'enablebanking_handler_error_heading_auth_failure' => 'Authentication Failure',
    'enablebanking_handler_error_contents_auth_failure' => 'An error occurred during the authentication process:',
    'enablebanking_handler_error_heading_session_invalid' => 'Invalid Session',
    'enablebanking_handler_error_contents_session_invalid' => 'The banking session is invalid or has expired.',
    'enablebanking_handler_error_heading_session_creation_failed' => 'Session Creation Failed',
    'enablebanking_handler_error_contents_session_creation_failed' => 'Could not create a banking session. Please try again.',
    'enablebanking_handler_error_heading_accounts_retrieval_failed' => 'Accounts Retrieval Failed',
    'enablebanking_handler_error_contents_accounts_retrieval_failed' => 'Could not retrieve account information. Please try again.',
    'enablebanking_handler_error_heading_session_no_accounts' => 'No Accounts Found',
    'enablebanking_handler_error_contents_session_no_accounts' => 'No bank accounts were found or accessible.',
    'enablebanking_handler_error_heading_auth_code_missing' => 'Authorization Code Missing',
    'enablebanking_handler_error_contents_auth_code_missing' => 'The authorization code was not provided. Please try the authentication process again.',
    'enablebanking_handler_return' => 'Return to application.',
    'enablebanking_search_placeholder' => 'Search financial institutions...',
    'enablebanking_connecting_to' => 'Connecting to:',
    'enablebanking_redirect_message' => 'You will be redirected to your bank for authentication.',
    'enablebanking_session_subject' => 'Bank connection expired, please reauthenticate.',
    'enablebanking_session_body' => 'Access to bank account feeds has expired. <br><br>Please log into Invoice Ninja and re-authenticate with your banks to continue receiving transactions.',
    'enablebanking_regions' => 'Regions: Europe & Global',
    'enablebanking_help' => 'Note: connecting an account requires an EnableBanking API key',
    'enablebanking_transaction_description' => 'New :type from :participant.',
