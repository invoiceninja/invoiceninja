...
$lang = array(
    ...
    'app_description' => 'A free, open-code solution for invoicing and billing customers. You can easily build and send beautiful invoices from any device that has access to the web. Your clients can print your invoices, download them as pdf files, and even pay you online from within the system.',
    'rows' => 'rows',
    'www' => 'www',
    'logo' => 'Logo',
    'subdomain' => 'Subdomain',
    ...
    'pro_plan_feature4' => 'Remove branding',
    ...
    'overdue' => 'Overdue',
    'white_label_text' => 'Purchase a ONE YEAR white label license for $:price to remove branding from the invoice and client portal.',
    ...
    'pro_plan_remove_logo' => ':link to remove the logo by joining the Pro Plan',
    ...
    'export_help' => 'Use JSON if you plan to import the data.<br/>The file includes clients, products, invoices, quotes and payments.',
    ...
    'wepay_account_description' => 'Payment gateway',
    ...
    'warning' => 'Warning',
    'self-update' => 'Update',
    'update_invoiceninja_title' => 'Update',
    'update_invoiceninja_warning' => 'Before start upgrading create a backup of your database and files!',
    'update_invoiceninja_available' => 'A new version is available.',
    'update_invoiceninja_unavailable' => 'No new version available.',
    ...
    'white_label_license_error' => 'Failed to validate the license, either expired or excessive activations.',
    ...
    'migrate_to_next_version' => 'Migrate to the next version',
    'migrate_intro_text' => 'We\'ve been working on next version. Click the button bellow to start the migration.',
    'start_the_migration' => 'Start the migration',
    'migration' => 'Migration',
    'welcome_to_the_new_version' => 'Welcome to the new version',
    ...
    'copy_link' => 'Copy Link',
    'welcome_to_invoice_ninja' => 'Welcome',
    'optin' => 'Opt-In',
    'optout' => 'Opt-Out',
    ...
    'application_settings_label' => 'Let\'s store basic information about your application!',
    ...
    'migration_already_completed_desc' => 'Looks like you already migrated <b> :company_name </b>to the V5 version. In case you want to start over, you can force migrate to wipe existing data.',
    ...
    'new_login_description' => 'You recently logged in to your account from a new location or device:<br><br><b>IP:</b> :ip<br><b>Time:</b> :time<br><b>Email:</b> :email',
    ...
    'stripe_connect_migration_desc' => 'v5 uses Stripe Connect to link your Stripe account. This provides an additional layer of security for your account. Now that you data has migrated, you will need to Authorize Stripe to accept payments in v5.<br><br>To do this, navigate to Settings > Online Payments > Configure Gateways. Click on Stripe Connect and then under Settings click Setup Gateway. This will take you to Stripe to authorize and on your return your account will be successfully linked!',
    ...
    'nordigen_requisition_body' => 'Access to bank account feeds has expired as set in End User Agreement. <br><br>Please log in and re-authenticate with your banks to continue receiving transactions.',
    ...
    'peppol_token_description' => 'Token is used as another step to make sure invoices are sent securely. Unlike white-label licenses, token can be rotated at any point without need to wait on support.',
    ...
    'einvoice_something_went_wrong' => 'Oops! Something went wrong.',
    ...
    'enable_public_notifications_help' => 'Enable real-time notifications.',
    'navigate' => 'Navigate',
    ...
    'pro_plan_feature_2' => 'Remove branding',
    ...
    'feedback_slider_title' => 'How likely are you to recommend this application to a friend or colleague?',
