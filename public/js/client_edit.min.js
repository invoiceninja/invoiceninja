...
var number_format_1 = __importDefault(__webpack_require__("./resources/js/src/utils/number-format.ts"));
...
exports.default = {
    ...
    computed: {
        settings_currency_id: {
            ...
            get: function () {
                var _this = this;
                return this.options_currency.find(function (obj) {
        ...
        settings_language_id: {
            ...
            get: function () {
                var _this = this;
                return this.options_language.find(function (obj) {
        ...
        settings_payment_terms: {
            ...
            get: function () {
                var _this = this;
                return this.options_payment_term.find(function (obj) {
    ...
    methods: {
        ...
        placeHolderCurrency: function () {
            var _this = this;
            var currency = this.options_currency.find(function (obj) {
        ...
        placeHolderPaymentTerm: function () {
            var _this = this;
            var payment_terms = this.payment_terms.find(function (obj) {
        ...
        placeHolderLanguage: function () {
            var _this = this;
            var language = this.languages.find(function (obj) {
        ...
        updateCurrencyExample: function () {
            var _this = this;
            var currency = this.options_currency.find(function (obj) {
                return obj.id == _this.company.settings_object.currency_id;
            });
            ...
            console.dir(new number_format_1.default(1000, currency, this.settings.show_currency_symbol, language).format());
            return new number_format_1.default(1000, currency, this.settings.show_currency_symbol, language).format();
        }
    }
};
                  ...
                  [
                    _c("div", { staticClass: "form-check form-check-inline" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.settings_show_currency_symbol,
                            expression: "settings_show_currency_symbol"
                          }
                        ],
                        ...
                        domProps: {
                          checked: _vm._q(
                            _vm.settings_show_currency_symbol,
                            "1"
                          )
                        },
                        on: {
                          click: function($event) {
                            _vm.setCurrencySymbol()
                          },
                          change: function($event) {
                            _vm.settings_show_currency_symbol = "1"
                          }
                        }
                      }),
                      _vm._v(" "),
                    ...
                    _c("div", { staticClass: "form-check form-check-inline" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.settings_show_currency_code,
                            expression: "settings_show_currency_code"
                          }
                        ],
                        staticClass: "form-check-input",
                        attrs: {
                        ...
                        domProps: {
                          checked: _vm._q(_vm.settings_show_currency_code, "1")
                        },
                        on: {
                          click: function($event) {
                            _vm.setCurrencyCode()
                          ...
                          change: function($event) {
                            _vm.settings_show_currency_code = "1"
                          }
                        }
                      }),
                      _vm._v(" "),
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.settings_send_reminders,
                              expression: "settings_send_reminders"
                            }
                          ],
                          staticClass: "switch-input",
                          attrs: { type: "checkbox", checked: "" },
                          domProps: {
                            checked: Array.isArray(_vm.settings_send_reminders)
                              ? _vm._i(_vm.settings_send_reminders, null) > -1
                              : _vm.settings_send_reminders
                          },
                          on: {
                            change: function($event) {
                              var $$a = _vm.settings_send_reminders,
                                $$el = $event.target,
                              ...
                              if (Array.isArray($$a)) {
                                ...
                                if ($$el.checked) {
                                  $$i < 0 &&
                                    (_vm.settings_send_reminders = $$a.concat([
                                      $$v
                                    ]))
                                } else {
                                  $$i > -1 &&
                                    (_vm.settings_send_reminders = $$a
                                      .slice(0, $$i)
                                      .concat($$a.slice($$i + 1)))
                                }
                              } else {
                                _vm.settings_send_reminders = $$c
                              }
                            }
                          }
                        }),
                        ...
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.settings_show_tasks_in_portal,
                              expression: "settings_show_tasks_in_portal"
                            }
                          ],
                          staticClass: "switch-input",
                          attrs: { type: "checkbox", checked: "" },
                          domProps: {
                            checked: Array.isArray(
                              _vm.settings_show_tasks_in_portal
                            )
                              ? _vm._i(
                                  _vm.settings_show_tasks_in_portal,
                                  null
                          ...
                          on: {
                            change: function($event) {
                              var $$a = _vm.settings_show_tasks_in_portal,
                                $$el = $event.target,
                                $$c = $$el.checked ? true : false
                              if (Array.isArray($$a)) {
                                var $$v = null,
                                ...
                                if ($$el.checked) {
                                  $$i < 0 &&
                                    (_vm.settings_show_tasks_in_portal = $$a.concat(
                                      [$$v]
                                    ))
                                } else {
                                  $$i > -1 &&
                                    (_vm.settings_show_tasks_in_portal = $$a
                                      .slice(0, $$i)
                                      .concat($$a.slice($$i + 1)))
                                }
                              } else {
                                _vm.settings_show_tasks_in_portal = $$c
                              }
                            }
                          }
                        }),
...
var NumberFormat = /** @class */ (function () {
     ...
     */
    function NumberFormat(amount, currency, symbol_decorator, language) {
        this.amount = amount;
