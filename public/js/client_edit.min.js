                      ...
                      _c("multiselect", {
                        ...
                        on: {
                          select: function($event) {
                            return _vm.currencySettingChange()
                          }
                        },
                        model: {
                  ...
                  _c(
                    ...
                    [
                      _c("multiselect", {
                        ...
                        model: {
                          value: _vm.settings.industry_id,
                          callback: function($$v) {
                            _vm.$set(_vm.settings, "industry_id", $$v)
                          },
                          expression: "settings.industry_id"
                        }
                      })
                    ],
                    1
