...
var client_settings_1 = __importDefault(__webpack_require__("./resources/js/src/utils/client-settings.ts"));
...
exports.default = {
    ...
    methods: {
        ...
        updateCurrencyExample: function (currency_symbol) {
            var _this = this;
            var currency = this.options_currency.find(function (obj) {
                return obj.id == _this.company.settings_object.currency_id;
            });
            ...
            return new number_format_1.default(1000, currency, currency_symbol, language).format();
        },
        currencySettingChange: function () {
                  ...
                  [
                        ...
                        [
                          _vm._v(
                            _vm._s(_vm.trans("texts.currency_symbol")) +
                              ": " +
                              _vm._s(_vm.currency_symbol_example)
                          )
                        ]
                      )
                    ]),
                    ...
                    _c("div", { staticClass: "form-check form-check-inline" }, [
                      ...
                      _c(
                        ...
                        [
                          _vm._v(
                            _vm._s(_vm.trans("texts.currency_code")) +
                              ": " +
                              _vm._s(_vm.currency_code_example)
                          )
                        ]
                      )
                    ])
                  ...
                  _c(
                    ...
                    [
                      _c("multiselect", {
                        ...
                        model: {
                          value: _vm.settings.payment_terms,
                          callback: function($$v) {
                            _vm.$set(_vm.settings, "payment_terms", $$v)
                          },
                          expression: "settings.payment_terms"
                        }
                      })
                    ],
                    1
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.settings.send_reminders,
                              expression: "settings.send_reminders"
                            }
                          ],
                          staticClass: "switch-input",
                          attrs: { type: "checkbox", checked: "" },
                          domProps: {
                            checked: Array.isArray(_vm.settings.send_reminders)
                              ? _vm._i(_vm.settings.send_reminders, null) > -1
                              : _vm.settings.send_reminders
                          },
                          on: {
                            change: function($event) {
                              var $$a = _vm.settings.send_reminders,
                                $$el = $event.target,
                              ...
                              if (Array.isArray($$a)) {
                                ...
                                _vm.$set(_vm.settings, "send_reminders", $$c)
                              }
                            }
                          }
                        }),
...
Object.defineProperty(exports, "__esModule", { value: true });
var client_settings_model_1 = __importDefault(__webpack_require__("./resources/js/src/models/client-settings-model.ts"));
var ClientSettings = /** @class */ (function () {
    /**
     * Create a new Client Settings instance.
     */
    function ClientSettings(client_settings, company_settings, languages, currencies, payment_terms, industries, sizes) {
