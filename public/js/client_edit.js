                ...
                _c("input", {
                  ...
                  on: {
                    input: function($event) {
                      ...
                      _vm.$set(_vm.client, "country", $event.target.value)
                    }
                  }
                }),
                _vm._v(" "),
                _vm.client.errors.has("country")
                  ? _c("div", {
                      staticClass: "text-danger",
                      domProps: {
                        textContent: _vm._s(_vm.client.errors.get("country"))
                      }
                    })
                  : _vm._e()
              ])
          ...
          _c("div", { staticClass: "form-group row" }, [
            ...
            _c("div", { staticClass: "col-sm-9" }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.client.shipping_country,
                    expression: "client.shipping_country"
                  }
                ],
                staticClass: "form-control",
                attrs: {
                ...
                domProps: { value: _vm.client.shipping_country },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
              ...
              _vm._v(" "),
              _vm.client.errors.has("shipping_country")
                ? _c("div", {
                    staticClass: "text-danger",
                    domProps: {
                      textContent: _vm._s(
                        _vm.client.errors.get("shipping_country")
                      )
                    }
                  })
                : _vm._e()
