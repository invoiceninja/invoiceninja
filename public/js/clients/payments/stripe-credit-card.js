...
var StripeCreditCard = /*#__PURE__*/function () {
  function StripeCreditCard(key, token, secret, onlyAuthorization) {
...
var token = (_document$querySelect2 = document.querySelector('meta[name="stripe-token"]').content) !== null && _document$querySelect2 !== void 0 ? _document$querySelect2 : '';
var secret = (_document$querySelect3 = document.querySelector('meta[name="stripe-secret"]').content) !== null && _document$querySelect3 !== void 0 ? _document$querySelect3 : '';
var onlyAuthorization = (_document$querySelect4 = document.querySelector('meta[name="only-authorization"]').content) !== null && _document$querySelect4 !== void 0 ? _document$querySelect4 : '';
...
module.exports = __webpack_require__(/*! /var/www/resources/js/clients/payments/stripe-credit-card.js */"./resources/js/clients/payments/stripe-credit-card.js");
