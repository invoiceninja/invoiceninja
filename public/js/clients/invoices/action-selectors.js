  ...
  _createClass(ActionSelectors, [{
    ...
    value: function handle() {
      ...
      try {
        ...
        for (var _iterator = document.querySelectorAll(".pay-now-button")[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          _loop();
        }
      } catch (err) {
