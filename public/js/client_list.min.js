...
exports.default = {
    ...
    mounted: function () {
        ...
        this.$events.$on('bulkAction', function (eventData) { return _this.bulk(eventData, _this); });
    ...
    methods: {
        ...
        bulk: function (action) {
            ...
            axios_1.default.post('/clients/bulk', {
                ...
                .then(function (response) { return _this.$refs.vuetable.refresh(); })
...
exports.default = {
    ...
    mounted: function () {
        var _this = this;
        this.$events.$on('bulk-count', function (eventData) { return _this.bulkCountUpdated(eventData); });
    },
    methods: {
        archive: function () {
        ...
        bulkCountUpdated: function (count) {
      ...
      _c("div", { staticClass: "btn-group" }, [
        _c(
          "button",
          {
            ...
            attrs: { type: "button", disabled: _vm.bulk_count == 0 },
            on: { click: _vm.archive }
          },
          [
            _vm._v(_vm._s(_vm.trans("texts.archive")) + " "),
            _vm.bulk_count > 0
              ? _c("span", [_vm._v("(" + _vm._s(_vm.bulk_count) + ")")])
              : _vm._e()
          ]
        ),
        _vm._v(" "),
...
var client_1 = __importDefault(__webpack_require__("./resources/js/src/store/modules/client.ts"));
...
/***/ "./resources/js/src/store/modules/client.ts":
/***/ (function(module, exports, __webpack_require__) {
