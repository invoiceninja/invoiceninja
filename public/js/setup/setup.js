...
var Setup = /*#__PURE__*/function () {
  function Setup() {
    ...
    this.checkDbEndpoint = document.querySelector('meta[name="test-db-endpoint"]').content;
    ...
    this.checkSmtpEndpoint = document.querySelector('meta[name="test-smtp-endpoint"]').content;
  }
  ...
  _createClass(Setup, [{
    ...
    value: function handleDatabaseCheck() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(this.checkDbEndpoint, data).then(function (response) {
        return _this.handleSuccess(_this.checkDbAlert);
      })["catch"](function (e) {
        return _this.handleFailure(_this.checkDbAlert);
      });
    }
  }, {
    key: "handleSmtpCheck",
    value: function handleSmtpCheck() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(this.checkSmtpEndpoint, data).then(function (response) {
        return _this2.handleSuccess(_this2.checkSmtpAlert);
      })["catch"](function (e) {
        return _this2.handleFailure(_this2.checkSmtpAlert);
      });
    }
  }, {
    key: "handleSuccess",
    ...
    value: function handle() {
      ...
      this.checkDbButton.addEventListener("click", function () {
        return _this3.handleDatabaseCheck();
      });
      this.checkSmtpButton.addEventListener("click", function () {
        return _this3.handleSmtpCheck();
      });
    }
  }]);
...
module.exports = __webpack_require__(/*! /home/david/Development/invoiceninja/resources/js/setup/setup.js */"./resources/js/setup/setup.js");
