...
var Setup = /*#__PURE__*/function () {
  ...
  _createClass(Setup, [{
    ...
    value: function handleDatabaseCheck() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/setup/check_db', data).then(function (response) {
    ...
    value: function handleSmtpCheck() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/setup/check_mail', data).then(function (response) {
    ...
    value: function handleTestPdfCheck() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/setup/check_pdf', {}).then(function (response) {
        try {
          var win = window.open(response.data.url, '_blank');
          win.focus();
          return _this3.handleSuccess(_this3.checkPdfAlert);
        } catch (error) {
          _this3.handleSuccess(_this3.checkPdfAlert);

          _this3.checkPdfAlert.textContent = "Success! You can preview test PDF here: ".concat(response.data.url);
        }
...
module.exports = __webpack_require__(/*! /var/www/resources/js/setup/setup.js */"./resources/js/setup/setup.js");
