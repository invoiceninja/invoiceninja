...
class RandomDataSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        factory(\App\Models\Client::class, 6000)->create(['user_id' => $user->id, 'company_id' => $company->id])->each(function ($c) use ($user, $company){
        ...
        /** Product Factory */
        factory(\App\Models\Product::class,500)->create(['user_id' => $user->id, 'company_id' => $company->id]);

        /** Invoice Factory */
        factory(\App\Models\Invoice::class,50000)->create(['user_id' => $user->id, 'company_id' => $company->id, 'client_id' => $client->id, 'settings' => ClientSettings::buildClientSettings($company->settings, $client->settings)]);
        ...
        factory(\App\Models\RecurringInvoice::class,2000)->create(['user_id' => $user->id, 'company_id' => $company->id, 'client_id' => $client->id]);
