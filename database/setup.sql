...
CREATE TABLE `account_email_settings` (
  ...
  `email_subject_quote_reminder1` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `email_subject_quote_reminder2` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `email_subject_quote_reminder3` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `email_subject_quote_reminder4` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `email_template_quote_reminder1` text COLLATE utf8_unicode_ci NOT NULL,
  `email_template_quote_reminder2` text COLLATE utf8_unicode_ci NOT NULL,
  `email_template_quote_reminder3` text COLLATE utf8_unicode_ci NOT NULL,
  `email_template_quote_reminder4` text COLLATE utf8_unicode_ci NOT NULL,
  `enable_quote_reminder1` tinyint(1) NOT NULL DEFAULT '0',
  `enable_quote_reminder2` tinyint(1) NOT NULL DEFAULT '0',
  `enable_quote_reminder3` tinyint(1) NOT NULL DEFAULT '0',
  `enable_quote_reminder4` tinyint(1) NOT NULL DEFAULT '0',
  `num_days_quote_reminder1` smallint(6) NOT NULL DEFAULT '7',
  `num_days_quote_reminder2` smallint(6) NOT NULL DEFAULT '14',
  `num_days_quote_reminder3` smallint(6) NOT NULL DEFAULT '30',
  `direction_quote_reminder1` smallint(6) NOT NULL DEFAULT '1',
  `direction_quote_reminder2` smallint(6) NOT NULL DEFAULT '1',
  `direction_quote_reminder3` smallint(6) NOT NULL DEFAULT '1',
  `field_quote_reminder1` smallint(6) NOT NULL DEFAULT '1',
  `field_quote_reminder2` smallint(6) NOT NULL DEFAULT '1',
  `field_quote_reminder3` smallint(6) NOT NULL DEFAULT '1',
  `frequency_id_quote_reminder4` int(10) unsigned DEFAULT NULL,
  `late_fee_quote1_amount` decimal(13,2) DEFAULT NULL,
  `late_fee_quote1_percent` decimal(13,3) DEFAULT NULL,
  `late_fee_quote2_amount` decimal(13,2) DEFAULT NULL,
  `late_fee_quote2_percent` decimal(13,3) DEFAULT NULL,
  `late_fee_quote3_amount` decimal(13,2) DEFAULT NULL,
  `late_fee_quote3_percent` decimal(13,3) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `account_gateway_settings` (
  ...
  `adjust_fee_percent` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `account_ticket_settings`
--

DROP TABLE IF EXISTS `account_ticket_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `account_ticket_settings` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `account_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `support_email_local_part` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `from_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `client_upload` tinyint(1) NOT NULL DEFAULT '1',
  `max_file_size` int(10) unsigned NOT NULL DEFAULT '0',
  `mime_types` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ticket_master_id` int(10) unsigned NOT NULL,
  `default_agent_id` int(10) unsigned DEFAULT NULL,
  `new_ticket_template_id` int(10) unsigned NOT NULL,
  `close_ticket_template_id` int(10) unsigned NOT NULL,
  `update_ticket_template_id` int(10) unsigned NOT NULL,
  `default_priority` int(10) unsigned NOT NULL,
  `ticket_number_prefix` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ticket_number_start` int(10) unsigned NOT NULL,
  `alert_new_comment_id` int(10) unsigned NOT NULL DEFAULT '0',
  `alert_new_comment_id_email` longtext COLLATE utf8_unicode_ci NOT NULL,
  `alert_ticket_assign_agent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `alert_ticket_assign_email` longtext COLLATE utf8_unicode_ci NOT NULL,
  `alert_ticket_overdue_agent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `alert_ticket_overdue_email` longtext COLLATE utf8_unicode_ci NOT NULL,
  `show_agent_details` tinyint(1) NOT NULL DEFAULT '1',
  `postmark_api_token` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `allow_inbound_email_tickets_external` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `account_ticket_settings_support_email_local_part_unique` (`support_email_local_part`),
  KEY `account_ticket_settings_ticket_master_id_foreign` (`ticket_master_id`),
  KEY `account_ticket_settings_account_id_index` (`account_id`),
  CONSTRAINT `account_ticket_settings_account_id_foreign` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `account_ticket_settings_ticket_master_id_foreign` FOREIGN KEY (`ticket_master_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `account_ticket_settings`
--

LOCK TABLES `account_ticket_settings` WRITE;
/*!40000 ALTER TABLE `account_ticket_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `account_ticket_settings` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `accounts` (
  ...
  `realtime_preview` tinyint(1) NOT NULL DEFAULT '1',
  ...
  `custom_fields_options` mediumtext COLLATE utf8_unicode_ci,
  `client_view_js` text COLLATE utf8_unicode_ci NOT NULL,
  `show_product_notes` tinyint(1) NOT NULL DEFAULT '0',
  `require_approve_quote` tinyint(1) NOT NULL DEFAULT '1',
  `valid_until_days` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `activities` (
  ...
  KEY `activities_ticket_id_account_id_index` (`ticket_id`,`account_id`),
  KEY `activities_contact_id_account_id_index` (`contact_id`,`account_id`),
  KEY `activities_payment_id_account_id_index` (`payment_id`,`account_id`),
  KEY `activities_invitation_id_account_id_index` (`invitation_id`,`account_id`),
  KEY `activities_user_id_account_id_index` (`user_id`,`account_id`),
  KEY `activities_invoice_id_account_id_index` (`invoice_id`,`account_id`),
  KEY `activities_client_id_account_id_index` (`client_id`,`account_id`),
...
INSERT INTO `gateways` VALUES (1,'2019-09-13 13:53:04','2019-09-13 13:53:04','Authorize.Net AIM','AuthorizeNet_AIM',1,1,5,0,NULL,0,0),(2,'2019-09-13 13:53:04','2019-09-13 13:53:04','Authorize.Net SIM','AuthorizeNet_SIM',1,2,10000,0,NULL,0,0),(3,'2019-09-13 13:53:04','2019-09-13 13:53:04','CardSave','CardSave',1,1,10000,0,NULL,0,0),(4,'2019-09-13 13:53:05','2019-09-13 13:53:05','Eway Rapid','Eway_RapidShared',1,1,10000,0,NULL,1,0),(5,'2019-09-13 13:53:05','2019-09-13 13:53:05','FirstData Connect','FirstData_Connect',1,1,10000,0,NULL,0,0),(6,'2019-09-13 13:53:05','2019-09-13 13:53:05','GoCardless','GoCardless',1,2,10000,0,NULL,1,0),(7,'2019-09-13 13:53:05','2019-09-13 13:53:05','Migs ThreeParty','Migs_ThreeParty',1,1,10000,0,NULL,0,0),(8,'2019-09-13 13:53:05','2019-09-13 13:53:05','Migs TwoParty','Migs_TwoParty',1,1,10000,0,NULL,0,0),(9,'2019-09-13 13:53:05','2019-09-13 13:53:05','Mollie','Mollie',1,1,8,0,NULL,1,0),(10,'2019-09-13 13:53:05','2019-09-13 13:53:05','MultiSafepay','MultiSafepay',1,1,10000,0,NULL,0,0),(11,'2019-09-13 13:53:05','2019-09-13 13:53:05','Netaxept','Netaxept',1,1,10000,0,NULL,0,0),(12,'2019-09-13 13:53:05','2019-09-13 13:53:05','NetBanx','NetBanx',1,1,10000,0,NULL,0,0),(13,'2019-09-13 13:53:05','2019-09-13 13:53:05','PayFast','PayFast',1,1,10000,0,NULL,1,0),(14,'2019-09-13 13:53:05','2019-09-13 13:53:05','Payflow Pro','Payflow_Pro',1,1,10000,0,NULL,0,0),(15,'2019-09-13 13:53:05','2019-09-13 13:53:05','PaymentExpress PxPay','PaymentExpress_PxPay',1,1,10000,0,NULL,0,0),(16,'2019-09-13 13:53:05','2019-09-13 13:53:05','PaymentExpress PxPost','PaymentExpress_PxPost',1,1,10000,0,NULL,0,0),(17,'2019-09-13 13:53:05','2019-09-13 13:53:05','PayPal Express','PayPal_Express',1,1,4,0,NULL,1,0),(18,'2019-09-13 13:53:05','2019-09-13 13:53:05','PayPal Pro','PayPal_Pro',1,1,10000,0,NULL,0,0),(19,'2019-09-13 13:53:05','2019-09-13 13:53:05','Pin','Pin',1,1,10000,0,NULL,0,0),(20,'2019-09-13 13:53:05','2019-09-13 13:53:05','SagePay Direct','SagePay_Direct',1,1,10000,0,NULL,0,0),(21,'2019-09-13 13:53:05','2019-09-13 13:53:05','SagePay Server','SagePay_Server',1,2,10000,0,NULL,1,0),(22,'2019-09-13 13:53:05','2019-09-13 13:53:05','SecurePay DirectPost','SecurePay_DirectPost',1,1,10000,0,NULL,0,0),(23,'2019-09-13 13:53:05','2019-09-13 13:53:05','Stripe','Stripe',1,1,1,0,NULL,0,0),(24,'2019-09-13 13:53:05','2019-09-13 13:53:05','TargetPay Direct eBanking','TargetPay_Directebanking',1,1,10000,0,NULL,0,0),(25,'2019-09-13 13:53:05','2019-09-13 13:53:05','TargetPay Ideal','TargetPay_Ideal',1,1,10000,0,NULL,0,0),(26,'2019-09-13 13:53:05','2019-09-13 13:53:05','TargetPay Mr Cash','TargetPay_Mrcash',1,1,10000,0,NULL,0,0),(27,'2019-09-13 13:53:05','2019-09-13 13:53:05','TwoCheckout','TwoCheckout',1,1,10000,0,NULL,1,0),(28,'2019-09-13 13:53:05','2019-09-13 13:53:05','WorldPay','WorldPay',1,1,10000,0,NULL,1,0),(29,'2019-09-13 13:53:05','2019-09-13 13:53:05','BeanStream','BeanStream',1,2,10000,0,NULL,0,0),(30,'2019-09-13 13:53:05','2019-09-13 13:53:05','Psigate','Psigate',1,2,10000,0,NULL,0,0),(31,'2019-09-13 13:53:05','2019-09-13 13:53:05','moolah','AuthorizeNet_AIM',1,1,10000,0,NULL,0,0),(32,'2019-09-13 13:53:05','2019-09-13 13:53:05','Alipay','Alipay_Express',1,1,10000,0,NULL,0,0),(33,'2019-09-13 13:53:05','2019-09-13 13:53:05','Buckaroo','Buckaroo_CreditCard',1,1,10000,0,NULL,0,0),(34,'2019-09-13 13:53:05','2019-09-13 13:53:05','Coinbase','Coinbase',1,1,10000,0,NULL,1,0),(35,'2019-09-13 13:53:05','2019-09-13 13:53:05','DataCash','DataCash',1,1,10000,0,NULL,0,0),(36,'2019-09-13 13:53:05','2019-09-13 13:53:05','Neteller','Neteller',1,2,10000,0,NULL,0,0),(37,'2019-09-13 13:53:05','2019-09-13 13:53:05','Pacnet','Pacnet',1,1,10000,0,NULL,0,0),(38,'2019-09-13 13:53:05','2019-09-13 13:53:05','PaymentSense','PaymentSense',1,2,10000,0,NULL,0,0),(39,'2019-09-13 13:53:05','2019-09-13 13:53:05','Realex','Realex_Remote',1,1,10000,0,NULL,0,0),(40,'2019-09-13 13:53:05','2019-09-13 13:53:05','Sisow','Sisow',1,1,10000,0,NULL,0,0),(41,'2019-09-13 13:53:05','2019-09-13 13:53:05','Skrill','Skrill',1,2,10000,0,NULL,1,0),(42,'2019-09-13 13:53:05','2019-09-13 13:53:05','BitPay','BitPay',1,1,7,0,NULL,1,0),(43,'2019-09-13 13:53:05','2019-09-13 13:53:05','Dwolla','Dwolla',1,2,6,0,NULL,1,0),(44,'2019-09-13 13:53:05','2019-09-13 13:53:05','AGMS','Agms',1,1,10000,0,NULL,0,0),(45,'2019-09-13 13:53:05','2019-09-13 13:53:05','Barclays','BarclaysEpdq\\Essential',1,1,10000,0,NULL,0,0),(46,'2019-09-13 13:53:05','2019-09-13 13:53:05','Cardgate','Cardgate',1,1,10000,0,NULL,0,0),(47,'2019-09-13 13:53:05','2019-09-13 13:53:05','Checkout.com','CheckoutCom',1,1,10000,0,NULL,0,0),(48,'2019-09-13 13:53:05','2019-09-13 13:53:05','Creditcall','Creditcall',1,1,10000,0,NULL,0,0),(49,'2019-09-13 13:53:05','2019-09-13 13:53:05','Cybersource','Cybersource',1,1,10000,0,NULL,0,0),(50,'2019-09-13 13:53:05','2019-09-13 13:53:05','ecoPayz','Ecopayz',1,1,10000,0,NULL,0,0),(51,'2019-09-13 13:53:05','2019-09-13 13:53:05','Fasapay','Fasapay',1,1,10000,0,NULL,0,0),(52,'2019-09-13 13:53:05','2019-09-13 13:53:05','Komoju','Komoju',1,1,10000,0,NULL,0,0),(53,'2019-09-13 13:53:05','2019-09-13 13:53:05','Multicards','Multicards',1,2,10000,0,NULL,0,0),(54,'2019-09-13 13:53:05','2019-09-13 13:53:05','Pagar.Me','Pagarme',1,2,10000,0,NULL,0,0),(55,'2019-09-13 13:53:05','2019-09-13 13:53:05','Paysafecard','Paysafecard',1,1,10000,0,NULL,0,0),(56,'2019-09-13 13:53:05','2019-09-13 13:53:05','Paytrace','Paytrace_CreditCard',1,1,10000,0,NULL,0,0),(57,'2019-09-13 13:53:05','2019-09-13 13:53:05','Secure Trading','SecureTrading',1,1,10000,0,NULL,0,0),(58,'2019-09-13 13:53:05','2019-09-13 13:53:05','SecPay','SecPay',1,1,10000,0,NULL,0,0),(59,'2019-09-13 13:53:05','2019-09-13 13:53:05','WeChat Express','WeChat_Express',1,2,10000,0,NULL,0,0),(60,'2019-09-13 13:53:05','2019-09-13 13:53:05','WePay','WePay',1,1,3,0,NULL,0,0),(61,'2019-09-13 13:53:05','2019-09-13 13:53:05','Braintree','Braintree',1,1,3,0,NULL,0,0),(62,'2019-09-13 13:53:05','2019-09-13 13:53:05','Custom','Custom1',1,1,20,0,NULL,1,0),(63,'2019-09-13 13:53:05','2019-09-13 13:53:05','FirstData Payeezy','FirstData_Payeezy',1,1,10000,0,NULL,0,0),(64,'2019-09-13 13:53:05','2019-09-13 13:53:05','GoCardless','GoCardlessV2\\Redirect',1,1,9,0,NULL,1,0),(65,'2019-09-13 13:53:05','2019-09-13 13:53:05','PagSeguro','PagSeguro',1,1,10000,0,NULL,0,0),(66,'2019-09-13 13:53:05','2019-09-13 13:53:05','PAYMILL','Paymill',1,1,10000,0,NULL,0,0),(67,'2019-09-13 13:53:05','2019-09-13 13:53:05','Custom','Custom2',1,1,21,0,NULL,1,0),(68,'2019-09-13 13:53:05','2019-09-13 13:53:05','Custom','Custom3',1,1,22,0,NULL,1,0);
...
CREATE TABLE `invitations` (
  ...
  KEY `invitations_deleted_at_invoice_id_index` (`deleted_at`,`invoice_id`),
...
CREATE TABLE `lookup_accounts` (
  ...
  UNIQUE KEY `lookup_accounts_support_email_local_part_unique` (`support_email_local_part`),
...
--
-- Table structure for table `lookup_ticket_invitations`
--

DROP TABLE IF EXISTS `lookup_ticket_invitations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lookup_ticket_invitations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `lookup_account_id` int(10) unsigned NOT NULL,
  `invitation_key` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ticket_hash` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `message_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `lookup_ticket_invitations_invitation_key_unique` (`invitation_key`),
  UNIQUE KEY `lookup_ticket_invitations_ticket_hash_unique` (`ticket_hash`),
  UNIQUE KEY `lookup_ticket_invitations_message_id_unique` (`message_id`),
  KEY `lookup_ticket_invitations_lookup_account_id_index` (`lookup_account_id`),
  CONSTRAINT `lookup_ticket_invitations_lookup_account_id_foreign` FOREIGN KEY (`lookup_account_id`) REFERENCES `lookup_accounts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lookup_ticket_invitations`
--

LOCK TABLES `lookup_ticket_invitations` WRITE;
/*!40000 ALTER TABLE `lookup_ticket_invitations` DISABLE KEYS */;
/*!40000 ALTER TABLE `lookup_ticket_invitations` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `payment_libraries` VALUES (1,'2019-09-13 13:53:04','2019-09-13 13:53:04','Omnipay',1),(2,'2019-09-13 13:53:04','2019-09-13 13:53:04','PHP-Payments [Deprecated]',1);
...
INSERT INTO `payment_terms` VALUES (1,7,'Net 7','2019-09-13 13:53:04','2019-09-13 13:53:04',NULL,0,0,1),(2,10,'Net 10','2019-09-13 13:53:04','2019-09-13 13:53:04',NULL,0,0,2),(3,14,'Net 14','2019-09-13 13:53:04','2019-09-13 13:53:04',NULL,0,0,3),(4,15,'Net 15','2019-09-13 13:53:04','2019-09-13 13:53:04',NULL,0,0,4),(5,30,'Net 30','2019-09-13 13:53:04','2019-09-13 13:53:04',NULL,0,0,5),(6,60,'Net 60','2019-09-13 13:53:04','2019-09-13 13:53:04',NULL,0,0,6),(7,90,'Net 90','2019-09-13 13:53:04','2019-09-13 13:53:04',NULL,0,0,7),(8,-1,'Net 0','2019-09-13 13:53:06','2019-09-13 13:53:06',NULL,0,0,0);
...
INSERT INTO `ticket_categories` VALUES (1,'Support','support','2019-09-13 13:52:55','2019-09-13 13:52:55',NULL);
...
CREATE TABLE `ticket_comments` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ticket_comments_account_id_foreign` (`account_id`),
  KEY `ticket_comments_user_id_foreign` (`user_id`),
  KEY `ticket_comments_ticket_id_foreign` (`ticket_id`),
  CONSTRAINT `ticket_comments_account_id_foreign` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`id`) ON DELETE CASCADE,
...
--
-- Table structure for table `ticket_invitations`
--

DROP TABLE IF EXISTS `ticket_invitations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ticket_invitations` (
  ...
  `public_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ticket_invitations_account_id_public_id_unique` (`account_id`,`public_id`),
  UNIQUE KEY `ticket_invitations_invitation_key_unique` (`invitation_key`),
  UNIQUE KEY `ticket_invitations_ticket_hash_unique` (`ticket_hash`),
  KEY `ticket_invitations_user_id_foreign` (`user_id`),
  KEY `ticket_invitations_contact_id_foreign` (`contact_id`),
  KEY `ticket_invitations_ticket_id_index` (`ticket_id`),
  KEY `ticket_invitations_public_id_index` (`public_id`),
  CONSTRAINT `ticket_invitations_contact_id_foreign` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `ticket_invitations_ticket_id_foreign` FOREIGN KEY (`ticket_id`) REFERENCES `tickets` (`id`) ON DELETE CASCADE,
  CONSTRAINT `ticket_invitations_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ticket_invitations`
--

LOCK TABLES `ticket_invitations` WRITE;
/*!40000 ALTER TABLE `ticket_invitations` DISABLE KEYS */;
/*!40000 ALTER TABLE `ticket_invitations` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ticket_relations` (
  ...
  `ticket_id` int(10) unsigned NOT NULL,
  `entity_url` text COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ticket_relations_ticket_id_foreign` (`ticket_id`),
  CONSTRAINT `ticket_relations_ticket_id_foreign` FOREIGN KEY (`ticket_id`) REFERENCES `tickets` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ticket_templates` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ticket_templates_account_id_foreign` (`account_id`),
  KEY `ticket_templates_user_id_foreign` (`user_id`),
  CONSTRAINT `ticket_templates_account_id_foreign` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `ticket_templates_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tickets` (
  ...
  `merged_parent_ticket_id` int(10) unsigned DEFAULT NULL,
  ...
  `private_notes` longtext COLLATE utf8_unicode_ci NOT NULL,
  `ccs` longtext COLLATE utf8_unicode_ci NOT NULL,
  `ip_address` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `contact_key` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `due_date` datetime NOT NULL,
  `closed` datetime NOT NULL,
  `reopened` datetime NOT NULL,
  `overdue_notification_sent` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tickets_account_id_foreign` (`account_id`),
...
CREATE TABLE `users` (
  ...
  `avatar_width` int(10) unsigned NOT NULL,
  `avatar_height` int(10) unsigned NOT NULL,
  `avatar_size` int(10) unsigned NOT NULL,
...
-- Dump completed on 2019-09-14  9:53:42
