...
CREATE TABLE `account_email_settings` (
  ...
  `email_template_reminder1` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `email_template_reminder2` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `email_template_reminder3` text COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `accounts` (
  ...
  `all_pages_footer` tinyint(1) DEFAULT NULL,
  `all_pages_header` tinyint(1) DEFAULT NULL,
  ...
  `logo_size` int(10) unsigned DEFAULT NULL,
  ...
  `start_of_week` int(11) DEFAULT NULL,
  ...
  `tax_rate2` decimal(13,3) DEFAULT NULL,
...
CREATE TABLE `companies` (
  ...
  `discount` double(8,2) NOT NULL DEFAULT '0.0',
...
CREATE TABLE `payments` (
  ...
  `public_id` int(10) unsigned NOT NULL,
  `refunded` decimal(13,2) DEFAULT NULL,
...
CREATE TABLE `vendors` (
  ...
  `currency_id` int(10) unsigned DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address1` varchar(255) COLLATE utf8_unicode_ci DEFAULT NOT,
  `address2` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `city` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `state` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `postal_code` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
