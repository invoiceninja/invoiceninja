    ...
    <div class="flex items-between my-5">
        <a href="/migration/hosted/credentials"
           class="w-1/2 bg-white shadow flex flex-col items-center justify-center hover:shadow-lg rounded-lg py-16 px-10 mxM-4">
            ...
            <p class="block text-center mt-2">Switch to managed version and continue using Invoice Ninja on official
                domain.</p>
        </a>
        <a href="/migration/self_hosted/credentials"
