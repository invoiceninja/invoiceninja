...
@section('body')
    ...
    <div class="flex items-between my-5">
        <a href="/migration/hosted/credentials" class="w-1/2 bg-white shadow flex flex-col items-center justify-center hover:shadow-lg rounded-lg py-16 px-10 mxM-4">
        ...
        <a href="/migration/self_hosted/credentials" class="w-1/2 bg-white shadow flex flex-col items-center justify-center hover:shadow-lg rounded-lg py-16 px-10 mx-4">
