<div wire:ignore.self class="@unless($form_only) container mx-auto grid grid-cols-12 @endunless mb-4 transitionduration-1000 ease-in-out h-500" data-ref="required-fields-container">
