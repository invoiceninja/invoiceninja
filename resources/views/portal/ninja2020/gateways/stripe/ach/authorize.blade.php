                ...
                <div>
                    <dl>
                        <form action="#" method="post" id="token-form">
                            ...
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 flex-col md:flex-row items-center">
                                <dt class="text-sm leading-5 font-medium text-gray-500">
                                    {{ ctrans('texts.confirm_account_number') }}
                                </dt>
                                <dd class="text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                                    <input class="input w-full" id="account-number-confirmation" type="text" required>
                                </dd>
                            </div>
                            <div class="bg-white px-4 py-5 sm:grid  sm:px-6 flex-col md:flex-row items-center">
