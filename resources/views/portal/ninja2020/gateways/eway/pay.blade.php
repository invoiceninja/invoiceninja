    ...
    <script>
        class EwayRapid {
            ...
            get groupFieldConfig() {
                return {
                    publicApiKey: document.querySelector('meta[name=public-api-key]')?.content,
                    ...
                    layout: {
                        ...
                        rows: [{
                                ...
                                cells: [{
                                        ...
                                        label: {
                                            fieldColSpan: 4,
                                            text: document.querySelector('meta[name=translation-card-name]')
                                                ?.content,
                                            styles: "",
                                        },
                                        field: {
                                    ...
                                    },
                                    {
                                        ...
                                        label: {
                                            fieldColSpan: 4,
                                            text: document.querySelector('meta[name=translation-expiry_date]')
                                                ?.content,
                                            styles: "",
                                        },
                                        field: {
                            ...
                            },
                            {
                                ...
                                cells: [{
                                        ...
                                        label: {
                                            fieldColSpan: 4,
                                            text: document.querySelector('meta[name=translation-card_number]')
                                                ?.content,
                                            styles: "",
                                        },
                                        field: {
