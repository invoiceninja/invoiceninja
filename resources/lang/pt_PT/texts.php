...
$LANG = array(
    ...
    'no_items' => 'Sem itens',
    'recurring_invoices' => 'Nota de Pagamento Recorrentes',
...
<li>"Pagamento de retentor para :QUARTER+1" >> "Pagamento de retentor para 3T"</li>
    ...
    'credit_amount' => 'Valor do Nota de Crédito',
    'credit_balance' => 'Balanço do Nota de Crédito',
    'credit_date' => 'Data do Nota de Crédito',
    ...
    'confirmation_required' => 'Por favor confirme o seu endereço de E-mail, :link para reenviar o E-mail de confirmação.',
    ...
    'confirmation_message' => 'Por favor clique no endereço infra para confirmar a sua conta.',
    ...
    'email_from' => 'Equipa InvoiceNinja',
    'invoice_link_message' => 'Para visualizar a nota de pagamento do seu cliente clique no endereço infra:',
    ...
    'reset_password' => 'Pode redefinir a sua palavra-passe clicando no seguinte endereço:',
    ...
    'agree_to_terms' => 'Eu concordo com os :terms',
    'terms_of_service' => 'Condições do Serviço',
    'email_taken' => 'O endereço de e-mail já se encontra registado',
    'working' => 'A processar',
    'success' => 'Sucesso',
    'success_message' => 'Registou-se com sucesso! Por favor verifique a sua caixa de E-mail para poder verificar a sua conta.',
...
-- envie-nos um email para contact@invoiceninja.com',
    ...
    'fill_products_help' => 'Ao selecionar o produto <b>descrição e preço</b> serão preenchidos automaticamente',
    'update_products' => 'Atualização automática dos produtos',
    'update_products_help' => 'Ao atualizar a nota de pagamento o <b>produto também será atualizado</b>',
    ...
    'invoice_design' => 'Design das Notas de Pagamento',
    ...
    'quote_message' => 'Para visualizar o orçamento de :amount, aceda ao link abaixo.',
    'quote_link_message' => 'Para visualizar o orçamento aceda ao link abaixo',
    ...
    'token_billing_3' => 'A caixa de seleção de Opt-out está visível e seleccionada',
    ...
    'app_description' => 'Invoice Ninja é uma solução de faturação e pagamento gratuita e open-source. Com Invoice Ninja, consegue facilmente construir e enviar notas de pagamento apelativas a partir de qualquer dispositivo com acesso à internet. Os seus clientes podem imprimir as notas de pagamento, transferi-las como ficheiros PDF e ainda pagar através da internet desde esta solução.',
    'rows' => 'linhas',
    'www' => 'www',
    'logo' => 'Logo',
    ...
    'dark_mode_help' => 'Utilizar fundo de tema escuro para as barras laterais',
    ...
    'quote_reminder_emails' => 'E-mails de Lembrete de Orçamento',
    ...
    'activity_10' => ':contact introduziu pagamento :payment para :payment_amount na nota de pagamento :invoice para :cliente',
    ...
    'activity_20' => ':user enviou orçamento :quote por E-mail para :client, :contact',
    ...
    'dropzone_default_message_disabled' => 'Uploads desativados',
    ...
    'stripe_ach_help' => 'Suporte para ACH também tem de estar habilitado em :link.',
...
Quando tiver os valores dos depósitos, volte a esta página e conclua a verificação da sua conta.',
 ...
 €0.25) por pagamento realizado.',
    ...
    'updated_credit' => 'Nota de Crédito atualizado com sucesso',
    ...
    'database_connection' => 'Ligação ao Banco de Dados',
    'driver' => 'Driver',
    'host' => 'Servidor',
    ...
    'fee_help' => 'Taxas de terminal são os custos cobrados por aceder as redes financeiras que tratam do processamento de pagamentos online.',
    ...
    'delete_company_message' => 'Aviso: Esta ação irá apagar permanentemente sua empresa, não há como desfazê-la.',
    ...
    'calendar' => 'Calendário',
    'pro_plan_calendar' => ':link para habilitar o calendário juntando-se ao Plano Profissional',
    ...
    'save_or_discard' => 'Guarde ou descarte suas mudanças',
    'discard_changes' => 'Descartar Mudanças',
    'tasks_not_enabled' => 'As tarefas não estão habilitadas.',
...
debitar da sua conta de acordo com essas instruções. Está elegível a um reembolso desse mesmo débito sob os termos e condições acordados entre si e o banco. O reembolso deve ser pedido nas 8 (oito) semanas seguintes a partir da data do débito.',
    ...
    'one_time_password' => 'Palavra-passe descartável',
    'set_phone_for_two_factor' => 'Defina seu número de telemóvel como um backup para ativar.',
    ...
    'self_host_login' => 'Login Auto-Hospedado',
    'set_self_hoat_url' => 'URL de Auto-Hospedado',
    'local_storage_required' => 'Erro: armazenamento local não está disponível.',
    'your_password_reset_link' => 'Endereço para recuperação da palavra-passe',
    ...
    'scheduled_report_attached' => 'O relatório agendado de :type está anexo.',
    'scheduled_report_error' => 'Falha ao criar relatório agendado',
    'invalid_one_time_password' => 'Palavra-passe descartável inválida',
