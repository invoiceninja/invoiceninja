...
$LANG = array(
    ...
    'hide_quantity_help' => 'Verberge die Mengenspalte, um Rechnungen übersichtlicher gestalten zu können.',
    ...
    'enable_with_stripe' => 'Aktivieren | Benötigt Stripe',
    ...
    'missing_publishable_key' => 'Stellen Sie Ihren Stripe "Publishable API Schlüssel" ein, um den Kassenprozess zu verbessern',
    'email_design' => 'E-Mail Design',
    'due_by' => 'Fällig am :date',
    'enable_email_markup' => 'Markup aktivieren',
    'enable_email_markup_help' => 'Vereinfachen Sie Ihren Kunden die Zahlung, indem Sie schema.org Markup zu Ihren E-Mails hinzufügen.',
    ...
    'light' => 'Hell',
    'dark' => 'Dunkel',
    'industry_help' => 'Wird genutzt um Vergleiche zwischen den Durchschnittswerten von Firmen ähnlicher Größe und Branche herstellen zu können.',
    ...
    'create_payment_term' => 'Erstelle Zahlungsbedingung',
    'edit_payment_terms' => 'Bearbeite Zahlungsbedingungen',
    'edit_payment_term' => 'Bearbeite Zahlungsbedingung',
    'archive_payment_term' => 'Archiviere Zahlungsbedingung',
    'recurring_due_dates' => 'Wiederkehrende Rechnungs-Fälligkeitsdaten',
    ...
    'invalid_mail_config' => 'Mailversand nicht möglich, prüfen Sie bitte Ihre E-Mail-Einstellungen auf Fehler.',
    ...
    'bank_account_error' => 'Kontodaten konnten nicht ermittelt werden. Bitte prüfen Sie Ihre Anmeldedaten.',
    ...
    'quote_issued_to' => 'Angebot ausgestellt an',
    ...
    'trial_success' => 'Erfolgreich eine 2-Wochen Testversion für den Pro-Plan aktiviert',
    'overdue' => 'Überfällig',
    ...
    'white_label_custom_css' => ':link für $:price um benutzerdefiniertes Styling zu erhalten und unterstützen Sie damit unser Projekt.',
    ...
    'custom_invoice_item_fields_help' => 'Füge ein Feld hinzu, wenn eine Rechnung erstellt wird und zeige dessen Bezeichnung und Wert auf der PDF.',
    ...
    'email_documents_example_1' => 'Dingsbums Kassenzettel.pdf',
    'email_documents_example_2' => 'Final Zustellbar.zip',
    ...
    'dropzone_file_too_big' => 'Datei ist zu groß ({{filesize}}MiB). Maximale Dateigröße: {{maxFilesize}}MiB.',
    'dropzone_invalid_file_type' => 'Sie können keine Dateien dieses Typs hochladen.',
    'dropzone_response_error' => 'Server antwortete mit Code: {{statusCode}}.',
    ...
    'enable_client_portal_dashboard_help' => 'Zeige an/Verstecke die Dashboard-Seite im Kundenportal.',
    ...
    'plan_change' => 'Zahlungsplan ändern',
    'pending_change_to' => 'Wechselt zu',
    'plan_changes_to' => ':plan am :date',
    'plan_term_changes_to' => ':plan (:term) am :date',
    'cancel_plan_change' => 'Wechsel abbrechen',
    'plan' => 'Plan',
    'expires' => 'läuft ab',
    'renews' => 'erneuert sich',
    'plan_expired' => ':plan Plan abgelaufen',
    'trial_expired' => ':plan Plan Probezeit abgelaufen',
    'never' => 'Nie',
    'plan_free' => 'Free',
    'plan_pro' => 'Pro',
    ...
    'plan_term_year' => 'Jahr',
    'plan_price_monthly' => '$:price/Monat',
    'plan_price_yearly' => '$:price/Jahr',
    'updated_plan' => 'Aktualisierte Zahlungsplan-Einstellungen',
    'plan_paid' => 'Periode gestartet',
    'plan_started' => 'Zahlungsplan gestartet',
    'plan_expires' => 'Zahlungsplan läuft ab',

    'white_label_button' => 'White Label',

    'pro_plan_year_description' => 'Ein-Jahres-Registrierung für den Invoice Ninja Pro-Plan.',
    'pro_plan_month_description' => 'Ein-Monats-Registrierung für den Invoice Ninja Pro-Plan.',
    'enterprise_plan_product' => 'Enterprise Plan',
    'enterprise_plan_year_description' => 'Ein-Jahres-Registrierung für den Invoice Ninja Enterprise-Plan.',
    'enterprise_plan_month_description' => 'Ein-Monats-Registrierung für den Invoice Ninja Enterprise-Plan.',
    'plan_credit_product' => 'Gutschrift',
    'plan_credit_description' => 'Gutschrift für nicht genutzte Zeit',
    'plan_pending_monthly' => 'Wird am :date auf monatliche Zahlung wechseln',
    'plan_refunded' => 'Eine Rückerstattung wurde veranlasst.',
    ...
    'switch' => 'Switch',
    'restore_account_gateway' => 'Gateway wiederherstellen',
    'restored_account_gateway' => 'Gateway erfolgreich wiederhergestellt',
    ...
    'on_send_date' => 'Am Versanddatum',
    'on_due_date' => 'Am Fälligkeitsdatum',
    'auto_bill_ach_date_help' => 'ACH auto bill geschieht immer am Fälligkeitsdatum',
    'warn_change_auto_bill' => 'Aufgrund der NACHA-Regeln, können Änderungen an dieser Rechnung die ACH auto bill verhindern.',

    'bank_account' => 'Bankkonto',
    'payment_processed_through_wepay' => 'ACH Zahlungen werden per WePay verarbeitet.',
    'wepay_payment_tos_agree' => 'Ich stimme den WePay :terms und der :privacy_policy. zu',
    'privacy_policy' => 'Datenschutzerklärung',
    'wepay_payment_tos_agree_required' => 'Sie müssen den WePay AGB und der Datenschutzerklärung zustimmen.',
    'payment_settings_supported_gateways' => 'Diese Einstellungen werden von den WePay, Stripe, und Braintree Gateways unterstützt.',
    'ach_email_prompt' => 'Bitte geben Sie eine gültige E-Mail-Adresse ein:',
    'verification_pending' => 'Überprüfung ausstehend',

    'update_font_cache' => 'Bitte führen Sie einen Force-Refresh (z.B. STRG+F5) der Webseite durch um den Font-Cache zu erneuern.',
    'more_options' => 'Weitere Optionen',
    'credit_card' => 'Kreditkarte',
    'bank_transfer' => 'Überweisung',
    'no_transaction_reference' => 'Wir erhielten keine Zahlungstransaktionsreferenz von dem Gateway.',
    ...
    'gateway_exists' => 'Dieses Gateway existiert bereits',
    ...
    // Industries
    'industry_Accounting & Legal' => 'Buchhaltung und Rechtswesen',
    ...
    'industry_Computers & Hightech' => 'Computer und Hightech',
    ...
    'industry_Media' => 'Medienkommunikation',
    'industry_Nonprofit & Higher Ed' => 'Gemeinnützige Unternehmen',
    'industry_Pharmaceuticals' => 'Arzneimittel',
    'industry_Professional Services & Consulting' => 'Professionelle Dienstleistungen und Consulting',
    ...
    'view_client_portal' => 'Zeige Kundenportal an',
    'view_portal' => 'Zeige Portal an',
    ...
    'expense_categories' => 'Ausgabenkategorie',
    'list_expense_categories' => 'Ausgabenkategorien anzeigen',
    'updated_expense_category' => 'Ausgabenkategorie erfolgeich aktualisiert',
    ...
    'restore_expense_category' => 'Stelle Ausgabenkategorie wieder her',
    ...
    'max_users_reached' => 'Die Höchstanzahl der Nutzer wurde erreicht.',
    ...
    'standard_fees_apply' => 'Standardgebühren werden erhoben: 2.9% + $0.30 pro erfolgreicher Belastung.',
    'limit_import_rows' => 'Daten müssen in Stapeln von :count Zeilen oder weniger importiert werden',
    'error_title' => 'Etwas lief falsch',
    'error_contact_text' => 'Wenn Sie möchten, helfen Sie uns bitte durch Kontaktaufnahme mit :mailaddress',
    ...
    'bot_get_email' => 'Hi! (wink)<br/>Danke für den Test des Invoice Ninja Bots.<br/>Sende mir die E-Mail-Adresse deines Accounts um zu starten.',
    ...
    'security_code_email_line1' => 'Dies ist dein Invoice Ninja Bot Sicherheitscode.',
    ...
    'city_state_postal' => 'Stadt/Staat/PLZ',
    ...
    'reseller_text' => 'Anmerkung: die "White-Label"-Lizenz ist gedacht für persönliche Nutzung. Bitte schicken Sie uns eine E-Mail an :email wenn Sie unsere App weiterverkaufen wollen.',
    'unnamed_client' => 'Unbenannter Kunde',

    'day' => 'Tag',
    'week' => 'Woche',
    'month' => 'Monat',
    'inactive_logout' => 'Sie wurden wegen Inaktivität ausgeloggt',
    'reports' => 'Berichte',
    ...
    'text' => 'Test',
    'expense_will_create' => 'Ausgabe wird erstellt',
    'expenses_will_create' => 'Ausgaben werden erstellt',
    ...
    'upgrade_for_features' => 'Upgrade für mehr Funktionen',
    ...
    'show_accept_invoice_terms' => 'Rechnungsbedingungen-Checkbox',
    'show_accept_invoice_terms_help' => 'Erfordere Bestätigung der Rechnungsbedingungen durch den Kunden.',
    'show_accept_quote_terms' => 'Angebotsbedingungen-Checkbos',
    'show_accept_quote_terms_help' => 'Erfordere Bestätigung der Angebotsbedingungen durch den Kunden.',
    'require_invoice_signature' => 'Rechnungsunterschrift',
    'require_invoice_signature_help' => 'Erfordere Unterschrift des Kunden bei Rechnungen.',
    'require_quote_signature' => 'Angebotsunterschrift',
    'require_quote_signature_help' => 'Erfordere Unterschrift des Kunden bei Angeboten.',
    'i_agree' => 'Ich akzeptiere die Bedingungen',
...
<ul><li>Flexible business lines of credit and invoice factoring.</li></ul>',
    ...
    'deleted_products' => ':count Produkte erfolgreich gelöscht',
    'restored_product' => 'Produkt erfolgreich wiederhergestellt',
    'update_credit' => 'Aktualisiere Saldo',
    ...
    'keyboard_shortcuts' => 'Schnellzugriffe auf der Tastatur',
    ...
    'promo_message' => 'Upgraden bevor :expires und erhalten :amount% Rabatt auf Ihr erstes Jahr unserer Pro oder Enterprise-Pakete.',
    'discount_message' => ':amount% Rabatt entfällt :expires',
    'mark_paid' => 'Markiere Bezahlt',
