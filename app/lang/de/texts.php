...
return array(
  ...
  'hide_quantity_help' => 'Wenn deine Menge immer 1 beträgt, kannst du deine Rechnung einfacher halten, indem du dieses Feld entfernst.',
  ...
  'charge_taxes' => 'Steuern berechnen',
  'user_management' => 'Benutzerverwaltung',
  'add_user' => 'Benutzer hinzufügen',
  'send_invite' => 'Einladung ver­sen­den',
  'sent_invite' => 'Einladung erfolgreich versendet',
  'updated_user' => 'Successfully updated user',
  'invitation_message' => 'Sie wurden von :invitor eingeladen. ',
  'register_to_add_user' => 'Bitte melden sie sich an, um einen Benutzer hinzuzufügen',
  'user_state' => 'Status',
  ...
  'limit_users' => 'Sorry, das wird das Limit von ' . MAX_NUM_USERS . ' Benutzern überschreiten',

  'confirm_email_invoice' => 'Bist du sicher, dass du diese Rechnung verschicken möchtest?',
  'confirm_email_quote' => 'Bist du sicher, dass du dieses Angebot verschicken möchtest?',
  'confirm_recurring_email_invoice' => 'Recurring is enabled, are you sure you want this invoice emailed?',

  'cancel_account' => 'Konto löschen',
  'cancel_account_message' => 'Warnung: Dies wird das permanente Löschen aller deiner Daten nachsichziehen, es gibt kein zurück.',
  'go_back' => 'Gehe zurück',

  'data_visualizations' => 'Datenvisualisierungen',
  'sample_data' => 'Beispieldaten angezeigt',
  'hide' => 'Ausblenden',
  ...
  'invoice_number_counter' => 'Rechnungsnummern Zähler',
  'quote_number_prefix' => 'Angebotsnummern Präfix',
  'quote_number_counter' => 'Angebotsnummern Zählern',
