...
class StoreUploadRequest extends FormRequest
{
    ...
    {
        return auth()->guard('vendor')->user()->vendor_id === $this->purchase_order->vendor_id && (bool) auth()->guard('vendor')->user()->vendor->company->getSetting('vendor_portal_enable_uploads');
    }
