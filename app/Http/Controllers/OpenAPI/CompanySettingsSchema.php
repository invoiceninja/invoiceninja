 ...
 *       @OA\Property(property="invoice_design_id", type="string", example="15", description="The design id (invoice, quote etc)"),
 *       @OA\Property(property="quote_design_id", type="string", example="15", description="The design id (invoice, quote etc)"),
