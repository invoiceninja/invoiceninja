...
class AccountantHtmlEngine
{
    ...
    public function buildEntityDataArray(): array
    {
        ...
        $data['$due_date'] = ['value' => $this->translateDate($this->entity->due_date, $this->company->date_format(), $this->company->locale()) ?: ' ', 'label' => ctrans('texts.'.$this->entity_string.'_due_date')];
        ...
        if ($this->entity_string == 'quote') {
            ...
            $data['$date'] = ['value' => $this->translateDate($this->entity->date, $this->company->date_format(), $this->company->locale()) ?: ' ', 'label' => ctrans('texts.quote_date')];
        ...
        $data['$credit.date'] = ['value' => $this->translateDate($this->entity->date, $this->company->date_format(), $this->company->locale()), 'label' => ctrans('texts.credit_date')];
        $data['$credit.valid_until'] = ['value' => $this->translateDate($this->entity->due_date, $this->company->date_format(), $this->company->locale()), 'label' => ctrans('texts.valid_until')];
        ...
        $data['$quote.date'] = ['value' => $this->translateDate($this->entity->date, $this->company->date_format(), $this->company->locale()) ?: ' ', 'label' => ctrans('texts.quote_date')];
        ...
        $data['$quote.valid_until'] = ['value' => $this->translateDate($this->entity->due_date, $this->company->date_format(), $this->company->locale()), 'label' => ctrans('texts.valid_until')];
        ...
        $data['$contact.signature_date'] = ['value' => $this->invitation->signature_date ? $this->translateDate($this->invitation->signature_date, $this->company->date_format(), $this->company->locale()) : ' ', 'label' => ctrans('texts.date')];
        ...
        if ($this->entity_string == 'invoice' && $this->entity->net_payments()->exists()) {
            ...
            foreach ($this->entity->net_payments as $payment) {
                $payment_list .= ctrans('texts.payment_subject') . ": " . $this->formatDate($payment->date, $this->company->date_format()) . " :: " . Number::formatMoney($payment->amount, $this->client) ." :: ". $payment->translatedType() . "<br>";
            }
            ...
            if ($payment) {
                ...
                $data['$payment.date'] = ['value' => $this->formatDate($payment->date, $this->company->date_format()), 'label' => ctrans('texts.payment_date')];
    ...
    private function getPaymentMeta(\App\Models\Payment $payment)
    {
        ...
        return collect($payment->refund_meta)
                ->map(function ($refund) use ($payment) {
                    ...
                    $date = $this->translateDate($date, $payment->company->date_format(), $payment->company->locale());
