...
/**
 * Creates Ninja products for QuickBooks Items that appeared in the CDC window
 * and do not yet exist locally.
 */
class CdcItemCreator extends AbstractCdcCreator
{
    ...
    protected function persist(array $records): void
    {
        ...
        $this->service->product->syncToNinja($records);
    }
}
