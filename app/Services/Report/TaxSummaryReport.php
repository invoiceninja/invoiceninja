    ...
    */
    ...
    public function run()
    {
        ...
        foreach ($query->cursor() as $invoice) {
            $calc = $invoice->calc();
            $taxes = array_merge($calc->getEffectiveTaxMap()->toArray(), $calc->getEffectiveTotalTaxMap())->toArray());
            ...
            foreach ($taxes as $tax) {
                ...
                $base_amount = (float) ($tax['base_amount'] ?? $calc->getEffectiveNetSubtotal()) * $multiplier;
