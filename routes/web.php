...
use App\Http\Controllers\InfinitePayController;
...
Route::get('/retorno-infinitepay/{invoice}', [InfinitePayController::class, 'handleRedirect'])->name('infinitepay.redirect');
