...
Route::middleware('throttle:10,1', 'api_secret_check', 'email_db')->group(function () {
    Route::post('api/v1/login', [Auth\LoginController::class, 'apiLogin'])->name('login.submit')->middleware('throttle:20,1');
...
Route::middleware('throttle:100,1', 'api_db', 'token_auth', 'locale')->prefix('api/v1')->name('api.')->group(function () {
    ...
    Route::post('refresh', [Auth\LoginController::class, 'refresh'])->middleware('throttle:150,3');

    Route::post('reports/clients', Reports\ClientReportController::class);
    Route::post('reports/contacts', Reports\ClientContactReportController::class);
    Route::post('reports/credits', Reports\CreditReportController::class);
    Route::post('reports/documents', Reports\DocumentReportController::class);
    Route::post('reports/expenses', Reports\ExpenseReportController::class);
    Route::post('reports/invoices', Reports\InvoiceReportController::class);
    Route::post('reports/invoice_items', Reports\InvoiceItemReportController::class);
    Route::post('reports/quotes', Reports\QuoteReportController::class);
    Route::post('reports/quote_items', Reports\QuoteItemReportController::class);
    Route::post('reports/recurring_invoices', Reports\RecurringInvoiceReportController::class);
    Route::post('reports/payments', Reports\PaymentReportController::class);
    Route::post('reports/products', Reports\ProductReportController::class);
    Route::post('reports/tasks', Reports\TaskReportController::class);
    Route::post('reports/profitloss', Reports\ProfitAndLossController::class);
...
Route::post('api/v1/process_webhook', [InAppPurchase\AppleController::class, 'process_webhook'])->middleware('throttle:1000,1');
Route::post('api/v1/confirm_purchase', [InAppPurchase\AppleController::class, 'confirm_purchase'])->middleware('throttle:1000,1');
