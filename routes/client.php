...
Route::group(['middleware' => ['invite_db'], 'prefix' => 'client', 'as' => 'client.'], function () {
    ...
    Route::get('invoice/{invitation_key}', 'ClientPortal\InvitationController@router');
    Route::get('quote/{invitation_key}', 'ClientPortal\InvitationController@router');
    Route::get('credit/{invitation_key}', 'ClientPortal\InvitationController@router');
