...
Route::get('client/subscriptions/{subscription}/purchase/v4', [App\Http\Controllers\ClientPortal\SubscriptionPurchaseController::class, 'v4'])->name('client.subscription.v4')->middleware('domain_db');
